...
import com.strategos.riesgos.models.tablas.entity.Respuesta;
import com.strategos.riesgos.models.tablas.services.IRespuestaService;
...
public class RespuestaRestController {
	...
	@GetMapping("/respuesta/page/{page}")
	public Page<Respuesta> index (@PathVariable Integer page){
		Pageable pageable= PageRequest.of(page, 10);
		return respuestaService.findAll(pageable);
	}

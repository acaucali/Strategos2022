...
import com.strategos.riesgos.models.tablas.services.IMacroProcesoService;
...
public class MacroProcesoRestController {
	...
	@Autowired
	private IMacroProcesoService macroProcesoService;
	...
	@GetMapping("/macroproceso/page/{page}")
	public Page<MacroProceso> index (@PathVariable Integer page){
		Pageable pageable= PageRequest.of(page, 10);
		return macroProcesoService.findAll(pageable);
	}

...
public class CausaRestController {
	...
	public ResponseEntity<?> create(@Valid @RequestBody CausaRiesgo causaRiesgo, BindingResult result, @PathVariable Long factorId) {
	...
	public ResponseEntity<?>  update(@Valid @RequestBody CausaRiesgo causasRiesgo, BindingResult result, @PathVariable Long id) {
		CausaRiesgo causaActual= causaService.findById(id);

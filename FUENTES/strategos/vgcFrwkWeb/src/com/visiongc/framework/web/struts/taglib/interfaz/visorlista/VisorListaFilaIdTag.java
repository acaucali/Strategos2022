...
public class VisorListaFilaIdTag
  extends VgcBodyBaseTag
{
  static final long serialVersionUID = 0L;
  public static final String KEY = "com.visiongc.framework.web.struts.taglib.interfaz.VisorLista.Fila.Id";
  
  public VisorListaFilaIdTag() {}
  ...
  public int doStartTag() throws JspException {
    ...
    if (filasVisorLista == null) {
      throw new JspException("El tag VisorListaFilaId debe estar dentro de un tag FilasVisorLista");
    }
    
    pageContext.setAttribute("com.visiongc.framework.web.struts.taglib.interfaz.VisorLista.Fila.Id", this);
  ...
  {
    filasVisorLista.getFila().setValorId(HtmlUtil.trimTextoHtml(bodyContent.getString()));
    
    pageContext.removeAttribute("com.visiongc.framework.web.struts.taglib.interfaz.VisorLista.Fila.Id");

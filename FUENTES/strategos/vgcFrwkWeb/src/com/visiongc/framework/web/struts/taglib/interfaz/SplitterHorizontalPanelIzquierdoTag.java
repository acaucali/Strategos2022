...
public class SplitterHorizontalPanelIzquierdoTag
  extends VgcBodyBaseTag
{
  static final long serialVersionUID = 0L;
  public static final String KEY = "com.visiongc.framework.web.struts.taglib.interfaz.SplitterHorizontal.PanelIzquierdo";
  
  public SplitterHorizontalPanelIzquierdoTag() {}
  ...
  public int doStartTag() throws JspException {
    ...
    if (splitter == null) {
      throw new JspException("El tag SplitterHorizontalPanelIzquierdo debe estar dentro de un tag SplitterHorizontal");
    }
  ...
  public int doEndTag() throws JspException
  {
    ...
    {
      pageContext.setAttribute("com.visiongc.framework.web.struts.taglib.interfaz.SplitterHorizontal.PanelIzquierdo" + splitter.getSplitterId(), bodyContent.getString());
    }

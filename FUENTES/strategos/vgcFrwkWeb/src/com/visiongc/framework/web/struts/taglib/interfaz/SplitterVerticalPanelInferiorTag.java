...
public class SplitterVerticalPanelInferiorTag
  extends VgcBodyBaseTag
{
  static final long serialVersionUID = 0L;
  public static final String KEY = "com.visiongc.framework.web.struts.taglib.interfaz.SplitterVertical.PanelInferior";
  
  public SplitterVerticalPanelInferiorTag() {}
  ...
  public int doStartTag() throws JspException {
    ...
    if (splitter == null) {
      throw new JspException("El tag SplitterVerticalPanelInferior debe estar dentro de un tag SplitterVertical");
    }
  ...
  public int doEndTag() throws JspException
  {
    ...
    {
      pageContext.setAttribute("com.visiongc.framework.web.struts.taglib.interfaz.SplitterVertical.PanelInferior" + splitter.getSplitterId(), bodyContent.getString());
    }

...
import com.visiongc.servicio.strategos.indicadores.model.util.PrioridadIndicador;
...
import com.visiongc.servicio.strategos.indicadores.model.util.TipoIndicador;
...
import com.visiongc.servicio.strategos.responsables.model.Responsable;
...
public class Indicador implements Serializable
{
	...
	private Set<SerieIndicador> seriesIndicador;
	...
	public Indicador(Long indicadorId, String nombre, String codigoEnlace, Byte frecuencia, Byte corte, Byte mesCierre, Byte tipoCargaMedicion, 
			Boolean valorInicialCero, Byte caracteristica, Byte naturaleza, Byte tipoSumaMedicion, Long organizacionId, Long claseId, Long alertaIndicadorIdZonaVerde,
			Long alertaIndicadorIdZonaAmarilla, Integer alertaMinMax, Double alertaMetaZonaVerde, Double alertaMetaZonaAmarilla, Byte alertaTipoZonaVerde,
			Byte alertaTipoZonaAmarilla, Boolean alertaValorVariableZonaVerde, Boolean alertaValorVariableZonaAmarilla, Long parametroSuperiorIndicadorId,
			Long parametroInferiorIndicadorId, Double parametroSuperiorValorFijo, Double parametroInferiorValorFijo, Byte tipoFuncion, Boolean asignarInventario, Long unidadId)
	{
		...
		this.organizacion.setMesCierre(mesCierre);
  ...
  public Set<SerieIndicador> getSeriesIndicador() {
    return this.seriesIndicador;
  }

  public void setSeriesIndicador(Set<SerieIndicador> seriesIndicador) {
  ...
  public String getPesoFormateado() {
    return VgcFormatter.formatearNumero(this.peso, 3);
  }

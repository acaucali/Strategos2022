...
public class PrioridadIndicador
  implements Serializable
{
  ...
  public static List<PrioridadIndicador> getPrioridades() {
    return getPrioridades(null);
  }

  public static List<PrioridadIndicador> getPrioridades(VgcMessageResources messageResources)
  {
    if (messageResources == null) {
      messageResources = VgcResourceManager.getMessageResources("StrategosWeb");
    }

    List<PrioridadIndicador> prioridades = new ArrayList<PrioridadIndicador>();

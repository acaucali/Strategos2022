...
public class TipoPerspectivaEstado implements Serializable
{
	...
	{
		return TIPO_PERSPECTIVA_ESTADO_PARCIAL;
	}
	
	public static Byte getTipoPerspectivaEstadoAnual() 
	{
		return TIPO_PERSPECTIVA_ESTADO_ANUAL;
	}
	
	public static List<TipoPerspectivaEstado> getTipos() 
	{
		return getTipos(null);
	}
	
	public static List<TipoPerspectivaEstado> getTipos(VgcMessageResources messageResources) 
	{
		 if (messageResources == null) 
			 messageResources = VgcResourceManager.getMessageResources("Strategos");
		 
		 List<TipoPerspectivaEstado> tipos = new ArrayList<TipoPerspectivaEstado>();

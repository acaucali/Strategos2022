  ...
  implements Serializable
{
  ...
  public String toString()
  {
    return new ToStringBuilder(this)
      .append("padreId", getPadreId())
      .append("indicadorId", getIndicadorId())
      .append("serieId", getSerieId())
      .append("insumoSerieId", getInsumoSerieId())
      .toString();
  }
  ...
  public boolean equals(Object other) {
    ...
    return new EqualsBuilder()
      .append(getPadreId(), castOther.getPadreId())
      .append(getIndicadorId(), castOther.getIndicadorId())
      .append(getSerieId(), castOther.getSerieId())
      .append(getInsumoSerieId(), castOther.getInsumoSerieId())
      .isEquals();
  }

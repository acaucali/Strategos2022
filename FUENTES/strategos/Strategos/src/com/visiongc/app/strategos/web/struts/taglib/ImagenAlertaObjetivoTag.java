...
public class ImagenAlertaObjetivoTag extends VgcBaseTag
{
  ...
  public int doStartTag() throws JspException
  {
    ...
    if (value != null) {
      ...
      if (valorAlerta.equals(AlertaObjetivo.getAlertaRoja()))
        nombreImagen = "alertaRoja.gif";
      else if (valorAlerta.equals(AlertaObjetivo.getAlertaAmarilla()))
        nombreImagen = "alertaAmarilla.gif";
      else if (valorAlerta.equals(AlertaObjetivo.getAlertaVerde()))
        nombreImagen = "alertaVerde.gif";
      else if (valorAlerta.equals(AlertaObjetivo.getAlertaVerdeAlterna()))
        nombreImagen = "alertaVerde.gif";
      else if (valorAlerta.equals(AlertaObjetivo.getAlertaNoDefinible())) {

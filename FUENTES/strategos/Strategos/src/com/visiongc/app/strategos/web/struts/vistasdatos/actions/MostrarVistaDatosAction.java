  ...
  extends VgcAction
{
    ...
    throws Exception
  {
    ...
    if (source == null)
    {
      if (reporteId == null)
      {
        configurarVistaDatosForm.setSource(Byte.valueOf(ConfigurarVistaDatosForm.SourceType.getSourceEditar()));
      ...
      else
      {
        ...
        configurarVistaDatosForm.setSource(Byte.valueOf(ConfigurarVistaDatosForm.SourceType.getSourceGestionar()));

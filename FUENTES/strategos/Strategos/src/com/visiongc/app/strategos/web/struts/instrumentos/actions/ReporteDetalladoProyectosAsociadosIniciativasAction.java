...
public class ReporteDetalladoProyectosAsociadosIniciativasAction extends VgcAction {
	@Override
	...
	public ActionForward execute(ActionMapping mapping, ActionForm form, HttpServletRequest request, HttpServletResponse response) throws Exception
	{
		...
		reporteForm.setSeleccionadoId(iniciativaId);
		
		System.out.print("\nIniciativa ID : " + reporteForm.getSeleccionadoId());

...
<tiles:insert definition="doc.loginLayout" flush="true">
	...
	<tiles:put name="title" type="String">
		<vgcutil:message key="jsp.expirado.titulo" />
	</tiles:put>
		...
		<html:form action="/logon" >
			...
			<table class="contenedorForma" cellspacing="2" cellpadding="2" width="600">
				...
				<tr>
					<logic:equal scope="page" name="hayEstilo" value="true">
						<logic:notEmpty scope="page" name="estiloSuperior">
							<td style="<%=estiloSuperior%>">..:: <vgcutil:message key="jsp.expirado.titulo" /></td>
						...
						<logic:empty scope="page" name="estiloSuperior">
							<td class="barraSuperiorForma">..:: <vgcutil:message key="jsp.expirado.titulo" /></td>
				...
				<tr>
					<td colspan="2"><!-- Este es la "Ficha de Datos" -->
	 					<table class="bordeFichaDatosIngreso" cellpadding="3" cellspacing="0">
							...
							<tr>
								<td align="left"><h2><vgcutil:message key="jsp.expirado.mensaje" /></h2></td>
							</tr>
						</table>
					</td>
				</tr>
				...
				<tr class="barraInferiorForma">
					<td colspan="2">
						<img src="<html:rewrite page='/componentes/formulario/aceptar.gif'/>" border="0" width="10" height="10" title="<vgcutil:message key="boton.generar.licencia" />">&nbsp;<a onMouseOver="this.className='mouseEncimaBarraInferiorForma'" onMouseOut="this.className='mouseFueraBarraInferiorForma'" href="javascript:generarLicencia();" class="mouseFueraBarraInferiorForma"><vgcutil:message key="boton.generar.licencia" /></a>&nbsp;&nbsp;&nbsp;&nbsp;
					</td>
				</tr>

...
<tiles:insert definition="doc.defaultLayout" flush="true">
	...
	<%-- Título --%>
	<tiles:put name="title" type="String"><vgcutil:message key="jsp.sessiontimeout.title" /></tiles:put>
	...
	<tiles:put name="body" type="String">
		...
		<table class="contenedorForma" cellspacing="2" cellpadding="2" width="500">
			...
			<tr>
				<logic:equal scope="page" name="hayEstilo" value="true">
					<logic:notEmpty scope="page" name="estiloSuperior">
						<td style="<%=estiloSuperior%>">..:: <vgcutil:message key="jsp.sessiontimeout.title" /></td>
						<td style="<%=estiloSuperior_left%>" align="right" width="30%"><img
							src="<html:rewrite page='/componentes/formulario/salir.gif'/>"
							...
							href="javascript:window.opener.closeAppWindows();" class="mouseFueraBarraSuperiorForma"><vgcutil:message
							key="boton.salir" /></a>&nbsp;&nbsp;&nbsp;&nbsp;</td>
					</logic:notEmpty>
					<logic:empty scope="page" name="estiloSuperior">
						<td class="barraSuperiorForma">..:: <vgcutil:message key="jsp.sessiontimeout.title" /></td>
			...
			<tr>
				<td colspan="2">
					...
					<table class="bordeFichaDatos" cellpadding="3" cellspacing="0" height="200px">
						...
						<tr>
							<td><img src="<html:rewrite page='/componentes/formulario/buscar.gif'/>" border="0" width="10" height="10"> <vgcutil:message key="jsp.sessiontimeout.message" /></td>
						</tr>
			...
			<tr class="barraInferiorForma">
				<td colspan="2"><img
					...
					border="0" width="10" height="10"
					title="<vgcutil:message key="boton.conectar" />"> <a
					onMouseOver="this.className='mouseEncimaBarraInferiorForma'"
					onMouseOut="this.className='mouseFueraBarraInferiorForma'"
					href="javascript:reiniciar();" class="mouseFueraBarraInferiorForma"><vgcutil:message
					key="boton.conectar" /></a>&nbsp;&nbsp;&nbsp;&nbsp;</td>
			</tr>

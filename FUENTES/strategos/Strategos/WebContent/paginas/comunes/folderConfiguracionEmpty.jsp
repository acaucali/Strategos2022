...
<tiles:insert definition="doc.loginLayout" flush="true">
	...
	<tiles:put name="title" type="String">
		<vgcutil:message key="jsp.folderconfiguracionempty.titulo" />
	</tiles:put>
				...
				<tr>
					<logic:equal scope="page" name="hayEstilo" value="true">
						<logic:notEmpty scope="page" name="estiloSuperior">
							<td style="<%=estiloSuperior%>">..:: <vgcutil:message key="jsp.folderconfiguracionempty.titulo" /></td>
						...
						<logic:empty scope="page" name="estiloSuperior">
							<td class="barraSuperiorForma">..:: <vgcutil:message key="jsp.folderconfiguracionempty.titulo" /></td>
				...
				<tr>
					<td colspan="2"><!-- Este es la "Ficha de Datos" -->
	 					<table class="bordeFichaDatosIngreso" cellpadding="3" cellspacing="0">
							...
							<tr>
								<td align="left"><h2><vgcutil:message key="jsp.folderconfiguracionempty.mensaje" /></h2></td>
							</tr>
						</table>
					</td>
				</tr>

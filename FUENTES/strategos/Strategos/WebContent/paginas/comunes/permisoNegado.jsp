...
<tiles:insert definition="doc.defaultLayout" flush="true">
	...
	<%-- Título --%>
	<tiles:put name="title" type="String"><vgcutil:message key="jsp.permisonegado.title" /></tiles:put>
	...
	<tiles:put name="body" type="String">
		...
		<table class="contenedorForma" cellspacing="2" cellpadding="2" width="450">
			...
			<tr>
				<logic:equal scope="page" name="hayEstilo" value="true">
					...
					<logic:empty scope="page" name="estiloSuperior">
						<td class="barraSuperiorForma">..:: <vgcutil:message key="jsp.permisonegado.title" /></td>
						<td class="barraSuperiorForma" align="right" width="30%">
						<img
							src="<html:rewrite page='/componentes/formulario/regresar.gif'/>"
							border="0" width="10" height="10"
			...
			<tr>
				<td colspan="2">
					...
					<table class="bordeFichaDatos" cellpadding="3" cellspacing="0" height="200px">
						...
						<tr>
							<td><img src="<html:rewrite page='/componentes/formulario/buscar.gif'/>" border="0" width="10" height="10"> <vgcutil:message key="jsp.permisonegado.message" /></td>
						</tr>

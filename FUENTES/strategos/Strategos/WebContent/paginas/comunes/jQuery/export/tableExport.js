...
(function($){
    $.fn.extend({
        ...
        function parseString(data)
        {
        	...
        	{
            	var $tot = $img[0];
            	if ($tot.src.indexOf("alertaVerde") != -1)
            		content_data = "Verde";
            	else if ($tot.src.indexOf("alertaRoja") != -1)
            		content_data = "Roja";
            	else if ($tot.src.indexOf("alertaAmarilla") != -1)
            		content_data = "Amarilla";
            	else if ($tot.src.indexOf("alertaBlanca") != -1)
            		content_data = "Blanca";
        	}
            else

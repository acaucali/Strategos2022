...
<tiles:insert definition="doc.modalLayout" flush="true">
	...
	<tiles:put name="title" type="String">
		...
		<logic:equal name="editarCargosForm" property="cargoId" value="0">
			<vgcutil:message key="jsp.editarcargos.titulo.nuevo" />
		</logic:equal>

		<%-- Para el caso de Modificar --%>
		<logic:notEqual name="editarCargosForm" property="cargoId" value="0">
			<vgcutil:message key="jsp.editarcargos.titulo.modificar" />
		</logic:notEqual>
	...
	<tiles:put name="body" type="String">
		...
		<script type="text/javascript">
			...
			function cancelar() {				
				window.document.editarCargosForm.action = '<html:rewrite action="/cargos/cancelarGuardarCargo"/>';
				window.document.editarCargosForm.submit();							
			}
		
			function guardar() {				
				if (validar(document.editarCargosForm)) {
					window.document.editarCargosForm.submit();					
				}	
			}

			function validar(forma) {
				if (validateEditarCargosForm(forma)) {
					window.document.editarCargosForm.action = '<html:rewrite action="/cargos/guardarCargo"/>' + '?ts=<%= (new java.util.Date()).getTime() %>';
					return true;
				} else {
					return false;
				}
		...
		<vgcinterfaz:setFocoObjetoInterfaz objetoInputHtml="document.editarCargosForm.nombre" />
		
		<%-- Forma asociada al Action - Jsp --%>
		<html:form action="/cargos/guardarCargo" focus="nombre" onsubmit="if (validar(document.editarCargosForm)) return true; else return false;">
			...
			<vgcinterfaz:contenedorForma width="560px" height="150px">
				...
				<table class="bordeFichaDatos" cellpadding="3" cellspacing="20" align="center" height="100%">
					...
					<tr>
						<td align="right"><vgcutil:message key="jsp.editarcargos.ficha.nombre" /></td>
				...
				<vgcinterfaz:contenedorFormaBarraInferior idBarraInferior="barraInferior">
					<logic:notEqual name="editarCargosForm" property="bloqueado" value="true">
		...
		<html:javascript formName="editarCargosForm" dynamicJavascript="true" staticJavascript="false" />

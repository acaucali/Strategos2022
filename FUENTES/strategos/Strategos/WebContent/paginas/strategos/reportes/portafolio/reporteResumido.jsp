...
<tiles:insert definition="doc.modalWindowLayout" flush="true">
	...
	<tiles:put name="title" type="String">
		..:: <vgcutil:message key="jsp.reportes.portafolio.ejecucion.resumido" />
	</tiles:put>
	...
	<tiles:put name="body" type="String">
			...
			function generarReporte() 
			{
			 	 if(!<%= session.getAttribute("isAdmin") %> && document.reporteForm.alcance.value == 3 ){
					...
					if (document.reporteForm.tipoReporte[0].checked)
						abrirReporte('<html:rewrite action="/reportes/portafolios/resumidaEjecucionPdf"/>?'+url+'&organizacionId=<bean:write name="organizacionId" scope="session" />');
		    	 	
					else if (document.reporteForm.tipoReporte[1].checked)
						abrirReporte('<html:rewrite action="/reportes/portafolios/resumidaEjecucionXls"/>?'+url+'&organizacionId=<bean:write name="organizacionId" scope="session" />');
			 	 }
				cancelar();
		...
		<html:form action="/reportes/portafolios/resumida">
							...
							<tr>
								<td colspan="3">
									...
									<html:radio property="alcance" value="<%= alcanceObjetivo %>">
										<vgcutil:message key="jsp.reportes.portafolio.portafolio" />
									</html:radio>
								</td>
							</tr>
								<tr>
									<td colspan="3">
										...
										<html:radio property="alcance" value="<%= alcanceOrganizacion %>">
											<vgcutil:message key="jsp.reportes.portafolio.portafolio.todos" />
										</html:radio>
									</td>
								</tr>
							<tr>

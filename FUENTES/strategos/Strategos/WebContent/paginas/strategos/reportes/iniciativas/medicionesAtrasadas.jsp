...
<tiles:insert definition="doc.modalWindowLayout" flush="true">
	...
	<tiles:put name="title" type="String">
		..:: <vgcutil:message
			key="jsp.gestionariniciativas.menu.reportes.mediciones.atrasadas" />
	</tiles:put>
	...
	<tiles:put name="body" type="String">
		...
		<%=session.getAttribute("isAdmin")%>
			&& document.reporteForm.alcance.value == 3) {
					...
					url = url + '&estatus='
							+ document.reporteForm.estatus.value;
					...
					if (document.reporteForm.tipoReporte[0].checked)
						abrirReporte('<html:rewrite action="/reportes/iniciativas/medicionesAtrasadasPdf"/>?'
								+ url
								+ '&organizacionId=<bean:write name="organizacionId" scope="session" />');

					else if (document.reporteForm.tipoReporte[1].checked)
						abrirReporte('<html:rewrite action="/reportes/iniciativas/medicionesAtrasadasXls"/>?'
								+ url
								+ '&organizacionId=<bean:write name="organizacionId" scope="session" />');
				}
				cancelar();
		...
		<html:form action="/reportes/iniciativas/medicionesAtrasadas">
			...
			<vgcinterfaz:contenedorForma width="460px" height="420px"
				...
				<%-- Paneles --%>
				<vgcinterfaz:contenedorPaneles height="320px" width="400px"
					...
					<vgcinterfaz:panelContenedor anchoPestana="110px" nombre="selector">
						...
						<table class="panelContenedor panelContenedorTabla">
							...
							<tr>
								<td colspan="3"><bean:define id="alcanceSubOrganizacion"
										toScope="page">
										<bean:write name="reporteForm"
											property="alcanceSubOrganizacion" />
									</bean:define> <html:radio property="alcance" value="4">
							...
							<tr>
								<td colspan="3">&nbsp; <vgcutil:message
									...
									property="estatus" width="5px" disabled="true">
										<option value="2" selected><vgcutil:message
												key="jsp.pagina.instrumentos.estatus.ejecucion" /></option>
								</select>
								</td>
							</tr>
							<tr>
					...
					<vgcinterfaz:panelContenedor anchoPestana="110px" nombre="salida">
						...
						<table class="panelContenedor panelContenedorTabla">
							...
							<tr>
								<td align="left"><vgcutil:message
										key="jsp.reportes.plan.ejecucion.plantilla.organizacion" /> :
								</td>
								<td colspan="1"><b><bean:write name="reporteForm"
											property="nombreOrganizacion" /></b></td>
							</tr>

...
<%-- Creado por: Andres Martinez (02/05/2024) --%>
...
<tiles:insert definition="doc.modalWindowLayout" flush="true">
	...
	<tiles:put name="title" type="String">
		..:: <vgcutil:message
			key="menu.evaluacion.reportes.cumplimiento" />
	</tiles:put>
	...
	<tiles:put name="body" type="String">
		...
		<script type="text/javascript">
			...
			{			 
				...
				if (document.reporteForm.tipoReporte[0].checked)
					abrirReporte('<html:rewrite action="/reportes/reporteCumplimientoPdf"/>?'+url+'&organizacionId=<bean:write name="organizacionId" scope="session" />');
		    	 	
				else if (document.reporteForm.tipoReporte[1].checked)
					abrirReporte('<html:rewrite action="/reportes/reporteCumplimientoXls"/>?'+url+'&organizacionId=<bean:write name="organizacionId" scope="session" />');
		...
		<html:form action="/reportes/reporteCumplimiento">

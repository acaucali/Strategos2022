	...
	<tiles:put name="body" type="String">
		...
		<script>
			...
			function aplicar()
			{
				...
				document.editarIniciativaForm.action = '<html:rewrite action="/iniciativas/desbloquearCulminadoSalvar"/>';
				document.editarIniciativaForm.submit();
		...
		<html:form action="/iniciativas/desbloquearCulminado" styleClass="formaHtml" enctype="multipart/form-data" method="POST">
			...
			<vgcinterfaz:contenedorForma width="570px" height="300" bodyAlign="center" bodyValign="center" >
				<vgcinterfaz:contenedorFormaTitulo nombre="tituloFicha">..::
						<vgcutil:message key="menu.herramientas.culminado" />
				</vgcinterfaz:contenedorFormaTitulo>
				<table class="bordeFichaDatostabla bordeFichaDatos">
					<tr>
					<td>
					<b>
					<vgcutil:message key="jsp.desbloquear.culminado" />
					</b>
					</td>
					</tr>
				</table>

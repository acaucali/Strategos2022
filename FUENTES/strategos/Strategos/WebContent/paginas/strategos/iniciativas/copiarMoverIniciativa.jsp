...
<tiles:insert definition="doc.modalLayout" flush="true">
	...
	<tiles:put name="title" type="String">
		<vgcutil:message key="jsp.copiar.mover.iniciativa.titulo" />
	</tiles:put>
	...
	<tiles:put name="body" type="String">
		...
		<script>
			...
			{
				var titulo = '..:: <vgcutil:message key="jsp.copiar.mover.iniciativa.titulo1" /> ' + pasoActual + ' <vgcutil:message key="jsp.copiar.mover.iniciativa.titulo2" />';
				var celda = document.getElementById("tituloFicha");
				celda.innerHTML = titulo;

				celda = document.getElementById("mensajeFinal");
				celda.innerHTML = '<vgcutil:message key="jsp.copiar.mover.iniciativa.finalizar.asistente" />' + ' "' + document.editarIndicadorForm.nombre.value + '" ' + '<vgcutil:message key="jsp.copiar.mover.iniciativa.finalizar.asistente3" />' + ' "' + document.editarIndicadorForm.nuevoNombre.value + '"' + '<vgcutil:message key="jsp.copiar.mover.iniciativa.finalizar.asistente4" />';
			}
		...
		<html:form action="/indicadores/copiarIndicador">
			...
			<vgcinterfaz:contenedorForma width="580px" height="395px" bodyAlign="center" bodyValign="center" >

...
<script type="text/javascript">
	...
	function abrirSelectorIniciativas(nombreForma, nombreCampoValores, nombreCampoIds, nombreCampoRutasCompletas, nombreCampoPlanId, funcionCierre, seleccionados, queryStringFiltros) 
	{		
		...
		abrirVentanaModal('<html:rewrite action="/iniciativas/seleccionarIniciativas" />?nombreForma=' + nombreForma
			...
			+ queryStringFiltros, 'seleccionarIniciativas', '750', '590');			
	}

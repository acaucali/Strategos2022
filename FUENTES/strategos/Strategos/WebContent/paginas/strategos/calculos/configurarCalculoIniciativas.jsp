...
<tiles:insert definition="doc.modalWindowLayout" flush="true">
	...
	<tiles:put name="title" type="String">
		<vgcutil:message key="jsp.configurarcalculoiniciativas.titulo" />
	</tiles:put>
	...
	<tiles:put name="body" type="String">
		...
		<script type="text/javascript">
			...
			{
				var titulo = '..:: <vgcutil:message key="jsp.configurarcalculoiniciativas.titulo1" /> ' + pasoActual + ' <vgcutil:message key="jsp.configurarcalculoiniciativas.titulo2" />';
			...
			function verDetalles(ocultarConfirmacion) 
			{
				if ((ocultarConfirmacion == null) || (!ocultarConfirmacion)) 
					verdetallescalculo = confirm ('<vgcutil:message key="jsp.configurarcalculoiniciativas.verdetallescalculo.confirm" />');
				else 
			...
			function calcular() 
			{
				...
				ajaxSendRequestReceiveInputSincronica('GET', '<html:rewrite action="/iniciativas/configurarCalculoIniciativas" />?funcion=getNumeroIndicadoresPorAlcance&alcance=' + alcance + indicadorId + porNombre, document.calculoIndicadoresForm.numeroIndicadoresAlcance, 'iniciarCalculo()');
			}
			...
			function iniciarCalculo() 
			{
				...
				document.calculoIndicadoresForm.action = '<html:rewrite action="/iniciativas/calcularIniciativas"/>' + xml;
			...
			var errmsgrango = '<vgcutil:message key="jsp.configurarcalculoiniciativas.errorrango"/>';
		</script>
		...
		<html:form action="/iniciativas/calcularIniciativas">
			...
			<vgcinterfaz:contenedorForma width="600px" height="400px" bodyAlign="center" bodyValign="center">
					...
					<tr height=315px>
						...
						<td><vgcinterfaz:contenedorPaneles height="270px" width="390px" nombre="contenedorPanelesCalculo" mostrarSelectoresPaneles="false">
									...
									<tr>
										<td>
											<table class="contenedorBotonesSeleccion" cellpadding="3" cellspacing="3" width="100%">
												<tr>
													<td><b><vgcutil:message key="jsp.configurarcalculoiniciativas.paso1.texto1" /></b> <vgcutil:message key="jsp.configurarcalculoiniciativas.presentacion" /></td>
												</tr>
											</table>
										</td>
									</tr>
								...
								<table class="contenedorBotonesSeleccion" cellpadding="3" cellspacing="3" width="100%" border="0">
										...
										<td>
											<b>
												<logic:equal property="origen" name="calculoIndicadoresForm" value="<%= origenOrganizaciones %>">
													<vgcutil:message key="jsp.configurarcalculoiniciativas.alcancecalculo" />
												</logic:equal>
												<logic:equal property="origen" name="calculoIndicadoresForm" value="<%= origenIndicadores %>">
													<vgcutil:message key="jsp.configurarcalculoiniciativas.alcancecalculo" />
												</logic:equal>
												<logic:equal property="origen" name="calculoIndicadoresForm" value="<%= origenPlanes %>">
													<vgcutil:message key="jsp.configurarcalculoiniciativas.alcancenivelcalculo" />
												</logic:equal>
										...
										<tr>
											<td>
												<html:radio property="alcance" value="<%= alcanceIndicador %>" onclick="eventoOnclickAlcance()">
													<vgcutil:message key="jsp.configurarcalculoiniciativas.indicadorsolo" />
												</html:radio> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
												<html:checkbox property="porNombre" onclick="eventoOnclickPorNombre()" styleClass="botonSeleccionMultiple">&nbsp;
														<vgcutil:message key="jsp.configurarcalculoiniciativas.indicadorpornombre" />
												</html:checkbox>
											</td>
										</tr>
									...
									<logic:equal property="origen" name="calculoIndicadoresForm" value="<%= origenPlanes %>">
										<tr>
											<td><html:radio property="alcance" value="<%= alcancePerspectiva %>" onclick="eventoOnclickAlcance()">
												<vgcutil:message key="jsp.configurarcalculoiniciativas.porperspectiva" />
											</html:radio></td>
										</tr>
										<tr>
											<td><html:radio property="alcance" value="<%= alcancePlan %>" onclick="eventoOnclickAlcance()">
												<vgcutil:message key="jsp.configurarcalculoiniciativas.porplan" />
											</html:radio></td>
										</tr>
									</logic:equal>
									...
									<logic:equal property="origen" name="calculoIndicadoresForm" value="<%= origenIniciativas %>">
										...
										<tr>
											<td><html:radio property="alcance" value="<%= alcanceIniciativa %>" onclick="eventoOnclickAlcance()">
												<vgcutil:message key="jsp.configurarcalculoiniciativas.poriniciativa" />
											</html:radio></td>
										</tr>
									</logic:equal>
									...
									<tr>
										<td><html:radio property="alcance" value="<%= alcanceOrganizacion %>" onclick="eventoOnclickAlcance()">
											<vgcutil:message key="jsp.configurarcalculoiniciativas.pororganizacion" />
										</html:radio></td>
									</tr>

									<tr>
										<td><html:radio property="alcance" value="<%= alcanceOrganizacionSeleccionada %>" onclick="eventoOnclickAlcance()">
											<vgcutil:message key="jsp.configurarcalculoiniciativas.pororganizacionseleccionada" />
										</html:radio></td>
									</tr>

									<tr>
										<td><html:radio property="alcance" value="<%= alcanceOrganizacionTodas %>" onclick="eventoOnclickAlcance()">
											<vgcutil:message key="jsp.configurarcalculoiniciativas.pororganizaciontodas" />
										</html:radio></td>
									</tr>
									...
									<tr>
										<td>
											<table style="font-family:Verdana; font-size:11; color:#666666; text-decoration:none;">
												<tr>
													<td align="left">
														<vgcutil:message key="jsp.configurarcalculoiniciativas.frecuencia" />
													</td>
													<td>
							...
							<vgcinterfaz:panelContenedor anchoPestana="50" nombre="panelLog" mostrarBorde="false">
								<table class="contenedorBotonesSeleccion" cellpadding="3" cellspacing="3" width="100%">
									<tr>
										<td><b><vgcutil:message key="jsp.configurarcalculoiniciativas.reportar" /></b></td>
									</tr>
									<tr>
										<td>&nbsp;</td>
									</tr>
									<tr>
										<td><html:checkbox property="reportarIndicadores" styleClass="botonSeleccionMultiple">&nbsp;
												<vgcutil:message key="jsp.configurarcalculoiniciativas.reportarindicadores" />
										</html:checkbox> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <html:checkbox property="reportarErrores" styleClass="botonSeleccionMultiple">&nbsp;
												<vgcutil:message key="jsp.configurarcalculoiniciativas.reportarerrores" />
										</html:checkbox></td>
									</tr>
								</table>
							</vgcinterfaz:panelContenedor>
		...
		<script>
			...
			<logic:equal name="calculoIndicadoresForm" property="status" value="2">
				alert('<vgcutil:message key="jsp.configurarcalculoiniciativas.actualizar.alerta.fin" />');
				cancelar();
			</logic:equal>

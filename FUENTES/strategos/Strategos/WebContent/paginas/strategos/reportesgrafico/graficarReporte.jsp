	...
	<tiles:put name="body" type="String">
		...
		<script>
			...
			function aplicar()
			{
				...
				grafico.url = '<html:rewrite action="/graficos/grafico"/>?reporteId='+ document.graficoReporteForm.reporteId.value +'&funcion=' + 'reporte' ;
				grafico.ShowForm(true, document.graficoReporteForm.indicadoresId.value, 'Indicador');
		...
		<html:form action="/reportesgrafico/graficarReporte" styleClass="formaHtml" enctype="multipart/form-data" method="POST">
		
			
			<html:hidden property="indicadoresId" />
			<html:hidden property="reporteId" />
			
			<%-- Campos hidden para el manejo de la insumos --%>
			<vgcinterfaz:contenedorForma width="400px" height="200" bodyAlign="center" bodyValign="center" >
				<vgcinterfaz:contenedorFormaTitulo nombre="tituloFicha">..::
						<vgcutil:message key="menu.herramientas.graficar" />
				</vgcinterfaz:contenedorFormaTitulo>
				<table class="bordeFichaDatostabla bordeFichaDatos">
					<tr>
					<td>
					<b>
					<vgcutil:message key="jsp.graficar.reporte" />
					</b>
					</td>
					</tr>
				</table>

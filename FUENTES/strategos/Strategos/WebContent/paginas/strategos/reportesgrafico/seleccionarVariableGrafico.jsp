...
<tiles:insert definition="doc.selectorLayout" flush="true">
	...
	<tiles:put name="body" type="String">
		...
		<script language="JavaScript" type="text/javascript">			
			...
			var seleccionMultiple = '<bean:write name="seleccionarVariableGraficoForm" property="seleccionMultiple" scope="session" />';
			
			function seleccionar() 
			{
				if ((document.seleccionarVariableGraficoForm.seleccionados.value == null) || (document.seleccionarVariableGraficoForm.seleccionados.value == "")) 
				{
					alert('<vgcutil:message key="jsp.seleccionar.noseleccion" />');
					return;
				}
				this.opener.document.<bean:write name="seleccionarVariableGraficoForm" property="nombreForma" scope="session" />.<bean:write name="seleccionarVariableGraficoForm" property="nombreCampoValor" scope="session" />.value=document.seleccionarVariableGraficoForm.valoresSeleccionados.value;
				this.opener.document.<bean:write name="seleccionarVariableGraficoForm" property="nombreForma" scope="session" />.<bean:write name="seleccionarVariableGraficoForm" property="nombreCampoOculto" scope="session" />.value=document.seleccionarVariableGraficoForm.seleccionados.value;				
				<logic:notEmpty name="seleccionarVariableGraficoForm" property="funcionCierre" scope="session">					
					this.opener.<bean:write name="seleccionarVariableGraficoForm" property="funcionCierre" scope="session" />;
				</logic:notEmpty>
				this.close();
			}
			...
			function eventoMouseEncimaFilaSeleccion(idsSeleccionados, fila) 
			{
		   	...
		   	{
		   		seleccionarVariableGraficoForm.filtroNombre.value = "";
		   		seleccionarVariableGraficoForm.submit();
			}
		...
		<html:form action="/reportesgrafico/seleccionarVariableGrafico" styleClass="formaHtml">
			...
			<vgcinterfaz:contenedorForma esSelector="true" comandoAceptarSelector="seleccionar()" comandoCancelarSelector="window.close()">
				...
				<vgcinterfaz:contenedorFormaBotonActualizar>
					javascript:document.seleccionarVariableGraficoForm.submit();
				</vgcinterfaz:contenedorFormaBotonActualizar>				
				...
				<table class="listView" cellpadding="5" id="tablaVariable" cellspacing="1">
					...
					<logic:iterate name="seleccionarVariableGraficoForm" property="listaVariables" scope="session" id="variable">

						<tr onclick="eventoClickFilaSeleccion(document.seleccionarVariableGraficoForm.seleccionados, document.seleccionarVariableGraficoForm.valoresSeleccionados, 'tablaVariable', this)"
							id="<bean:write name="variable" property="valor" />" class="mouseFueraCuerpoListView" onMouseOver="eventoMouseEncimaFilaSeleccion(document.seleccionarVariableGraficoForm.seleccionados, this)"
							onMouseOut="eventoMouseFueraFilaSeleccion(document.seleccionarVariableGraficoForm.seleccionados, this)" height="20px">
			...
			<script language="JavaScript" type="text/javascript">
				...
				inicializarVisorListaSeleccion(document.seleccionarVariableGraficoForm.seleccionados, 'tablaVariable');

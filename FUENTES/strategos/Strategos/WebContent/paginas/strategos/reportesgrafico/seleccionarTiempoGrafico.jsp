...
<tiles:insert definition="doc.selectorLayout" flush="true">
	...
	<tiles:put name="body" type="String">
		...
		<script language="JavaScript" type="text/javascript">			
			...
			var seleccionMultiple = '<bean:write name="seleccionarTiempoGraficoForm" property="seleccionMultiple" scope="session" />';
			
			function seleccionar() {
				if ((document.seleccionarTiempoGraficoForm.seleccionados.value == null) || (document.seleccionarTiempoGraficoForm.seleccionados.value == "")) {
					alert('<vgcutil:message key="jsp.seleccionar.noseleccion" />');
					return;
				}
				this.opener.document.<bean:write name="seleccionarTiempoGraficoForm" property="nombreForma" scope="session" />.<bean:write name="seleccionarTiempoGraficoForm" property="nombreCampoValor" scope="session" />.value=document.seleccionarTiempoGraficoForm.valoresSeleccionados.value;
				this.opener.document.<bean:write name="seleccionarTiempoGraficoForm" property="nombreForma" scope="session" />.<bean:write name="seleccionarTiempoGraficoForm" property="nombreCampoOculto" scope="session" />.value=document.seleccionarTiempoGraficoForm.seleccionados.value;				
				<logic:notEmpty name="seleccionarTiempoGraficoForm" property="funcionCierre" scope="session">					
					this.opener.<bean:write name="seleccionarTiempoGraficoForm" property="funcionCierre" scope="session" />;
				</logic:notEmpty>
				this.close();
			}
			...
			function eventoMouseEncimaFilaSeleccion(idsSeleccionados, fila) {
		   	...
		   	function limpiarFiltros() {
		   		seleccionarTiempoGraficoForm.periodoInicial.value = "";
		   		seleccionarTiempoGraficoForm.anoInicial.value = "";
		   		seleccionarTiempoGraficoForm.periodoFinal.value = "";
		   		seleccionarTiempoGraficoForm.anoFinal.value = "";
		   		seleccionarTiempoGraficoForm.submit();
			}
		...
		<html:form action="/reportesgrafico/seleccionarTiempoGrafico" styleClass="formaHtml">
			...
			<vgcinterfaz:contenedorForma esSelector="true" comandoAceptarSelector="seleccionar()" comandoCancelarSelector="window.close()">
				...
				<vgcinterfaz:contenedorFormaBotonActualizar>
					javascript:document.seleccionarTiempoGraficoForm.submit();
				</vgcinterfaz:contenedorFormaBotonActualizar>
				...
				<vgcinterfaz:contenedorFormaBarraGenerica height="20px">
					...
					<table width="100%" cellpadding="1" cellspacing="0">
						...
						<tr class="barraFiltrosForma">
							...
							<logic:equal name="seleccionarTiempoGraficoForm" property="frecuenciaBloqueada" value="1">
								<td><html:text styleClass="cuadroTexto" property="nombreFrecuencia" readonly="true"></html:text></td>
							</logic:equal>
							<logic:equal name="seleccionarTiempoGraficoForm" property="frecuenciaBloqueada" value="0">
				...
				<table class="listView" cellpadding="5" id="tablaTiempo" cellspacing="1">
					...
					<logic:iterate name="seleccionarTiempoGraficoForm" property="anosPeriodos" scope="session" id="tiempo">

						<tr onclick="eventoClickFilaSeleccion(document.seleccionarTiempoGraficoForm.seleccionados, document.seleccionarTiempoGraficoForm.valoresSeleccionados, 'tablaTiempo', this)"
							id="<bean:write name="tiempo" property="valor" />" class="mouseFueraCuerpoListView" onMouseOver="eventoMouseEncimaFilaSeleccion(document.seleccionarTiempoGraficoForm.seleccionados, this)"
							onMouseOut="eventoMouseFueraFilaSeleccion(document.seleccionarTiempoGraficoForm.seleccionados, this)" height="20px">
			...
			<script language="JavaScript" type="text/javascript">
				...
				inicializarVisorListaSeleccion(document.seleccionarTiempoGraficoForm.seleccionados, 'tablaTiempo');

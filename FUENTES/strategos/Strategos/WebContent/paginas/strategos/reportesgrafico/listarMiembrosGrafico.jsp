...
<script type="text/javascript">
		...
		function aceptar() 
		{
		    ...
		    window.document.configurarReporteGraficoForm.action = '<html:rewrite action="/reportesgrafico/mostrarReporteGrafico"/>' + '?ts=<%= (new java.util.Date()).getTime() %>';
		...
		function seleccionarMiembros() 
	    {
			...
			var frecuencia = document.configurarReporteGraficoForm.frecuencia.value;
	 	    var url = '';
	 	        
	 	    parametros = parametros + '&frecuenciaBloqueada=1&frecuencia=' + frecuencia; 
	 	    if (document.configurarReporteGraficoForm.seleccionadosDimensiones.value == tipoDimensionTiempo) 
				url = '<html:rewrite action="/reportesgrafico/seleccionarTiempoGrafico" />';
			if (document.configurarReporteGraficoForm.seleccionadosDimensiones.value == tipoDimensionAtributo) 
				url = '<html:rewrite action="/reportesgrafico/seleccionarAtributoGrafico" />';
			if (document.configurarReporteGraficoForm.seleccionadosDimensiones.value == tipoDimensionVariable) 
	 	    	url = '<html:rewrite action="/reportesgrafico/seleccionarVariableGrafico" />';
			if (document.configurarReporteGraficoForm.seleccionadosDimensiones.value == tipoDimensionOrganizacion) 
	 	    	url = '<html:rewrite action="/reportesgrafico/seleccionarOrganizacionGrafico" />';
			if (document.configurarReporteGraficoForm.seleccionadosDimensiones.value == tipoDimensionPlan) 
	 	    	url = '<html:rewrite action="/reportesgrafico/seleccionarPlanGrafico" />';
			if (document.configurarReporteGraficoForm.seleccionadosDimensiones.value == tipoDimensionIndicador)
			{
	 	    	//url = '<html:rewrite action="/vistasdatos/seleccionarIndicador" />';
				var forma = 'configurarReporteGraficoForm';
				...
				abrirSelectorMiembro(url, 'configurarReporteGraficoForm', 'nombreMiembro', 'miembroId', null, 'agregarMiembros()', parametros);
		}
		...
		{
			var seleccionadoIds = document.configurarReporteGraficoForm.indicadorInsumoSeleccionadoIds.value.split('<bean:write name="configurarReporteGraficoForm" property="separadorIndicadores" ignore="true"/>');
			var seleccionadoNombres = document.configurarReporteGraficoForm.indicadorInsumoSeleccionadoNombres.value.split('<bean:write name="configurarReporteGraficoForm" property="separadorIndicadores" ignore="true"/>');
			var seleccionadoSeriePlanId = document.configurarReporteGraficoForm.indicadorInsumoSeleccionadoSeriePlanId.value.split('<bean:write name="configurarReporteGraficoForm" property="separadorIndicadores" ignore="true"/>');
			var separadorSeries = '<bean:write name="configurarReporteGraficoForm" property="separadorSeries" scope="session" />';
		...
		function agregarMiembros() 
		{
			...
			if ((window.document.configurarReporteGraficoForm.miembroId.value != null) && (window.document.configurarReporteGraficoForm.miembroId.value != '')) 
			{			
			   arrNombreMiembro = window.document.configurarReporteGraficoForm.nombreMiembro.value.split(",");
			   arrMiembroId = window.document.configurarReporteGraficoForm.miembroId.value.split(",");			
			}
		...
		{
			if ((window.document.configurarReporteGraficoForm.textoMiembros.value != null) && (window.document.configurarReporteGraficoForm.textoMiembros.value != "")) 
			{				
				arregloMiembros = window.document.configurarReporteGraficoForm.textoMiembros.value.split(separadorElementos);				
				dibujarTablaMiembros();
			}
		}

...
<tiles:insert definition="doc.selectorLayout" flush="true">
	...
	<tiles:put name="body" type="String">
		...
		<script language="JavaScript" type="text/javascript">			
			...
			var seleccionMultiple = '<bean:write name="seleccionarOrganizacionGraficoForm" property="seleccionMultiple" scope="session" />';
			
			function seleccionar() {
				if ((document.seleccionarOrganizacionGraficoForm.seleccionados.value == null) || (document.seleccionarOrganizacionGraficoForm.seleccionados.value == "")) {
					alert('<vgcutil:message key="jsp.seleccionar.noseleccion" />');
					return;
				}
				this.opener.document.<bean:write name="seleccionarOrganizacionGraficoForm" property="nombreForma" scope="session" />.<bean:write name="seleccionarOrganizacionGraficoForm" property="nombreCampoValor" scope="session" />.value=document.seleccionarOrganizacionGraficoForm.valoresSeleccionados.value;
				this.opener.document.<bean:write name="seleccionarOrganizacionGraficoForm" property="nombreForma" scope="session" />.<bean:write name="seleccionarOrganizacionGraficoForm" property="nombreCampoOculto" scope="session" />.value=document.seleccionarOrganizacionGraficoForm.seleccionados.value;				
				<logic:notEmpty name="seleccionarOrganizacionGraficoForm" property="funcionCierre" scope="session">					
					this.opener.<bean:write name="seleccionarOrganizacionGraficoForm" property="funcionCierre" scope="session" />;
				</logic:notEmpty>
				this.close();
			}
			...
			function eventoMouseEncimaFilaSeleccion(idsSeleccionados, fila) {
		   	...
		   	function limpiarFiltros() {
		   		seleccionarOrganizacionGraficoForm.filtroNombre.value = "";				
		   		seleccionarOrganizacionGraficoForm.submit();
			}
		...
		<html:form action="/reportesgrafico/seleccionarOrganizacionGrafico" styleClass="formaHtml">
			...
			<vgcinterfaz:contenedorForma esSelector="true" comandoAceptarSelector="seleccionar()" comandoCancelarSelector="window.close()">
				...
				<vgcinterfaz:contenedorFormaBotonActualizar>
					javascript:document.seleccionarOrganizacionGraficoForm.submit();
				</vgcinterfaz:contenedorFormaBotonActualizar>
				...
				<table class="listView" cellpadding="5" id="tablaOrganizacion" cellspacing="1">
					...
					<logic:iterate name="seleccionarOrganizacionGraficoForm" property="listaOrganizaciones" scope="session" id="organizacion">

						<tr onclick="eventoClickFilaSeleccion(document.seleccionarOrganizacionGraficoForm.seleccionados, document.seleccionarOrganizacionGraficoForm.valoresSeleccionados, 'tablaOrganizacion', this)"
							id="<bean:write name="organizacion" property="organizacionId" />" class="mouseFueraCuerpoListView"
							onMouseOver="eventoMouseEncimaFilaSeleccion(document.seleccionarOrganizacionGraficoForm.seleccionados, this)"
							onMouseOut="eventoMouseFueraFilaSeleccion(document.seleccionarOrganizacionGraficoForm.seleccionados, this)" height="20px">
			...
			<script language="JavaScript" type="text/javascript">
				...
				inicializarVisorListaSeleccion(document.seleccionarOrganizacionGraficoForm.seleccionados, 'tablaOrganizacion');

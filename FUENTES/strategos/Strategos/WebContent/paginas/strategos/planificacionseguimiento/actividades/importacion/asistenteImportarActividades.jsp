...
<%-- @Author: Andres Martinez (15/09/2023) --%>

<tiles:insert definition="doc.modalWindowLayout" flush="true">

	<%-- Titulo --%>
	<tiles:put name="title" type="String">
		<vgcutil:message key="jsp.asistente.importacion.actividad.titulo" />
	</tiles:put>

	<%-- Cuerpo --%>
	<tiles:put name="body" type="String">
		<link rel="stylesheet" type="text/css"
			href="<html:rewrite page="/componentes/estilos/browserFile.css" />">
		...
		function salvar()
		{
			...
			xml = xml + '&archivo=' + document.importarActividadesForm.fuenteSeleccionArchivo.value;				
			xml = xml + '&logErrores=' + (document.importarActividadesForm.logErrores.checked ? 1 : 0);				
			xml = xml + '&showPresentacion=' + (document.importarActividadesForm.showPresentacion.checked ? 1 : 0);		
			xml = xml + '&tipoImportacion=' + 8;

			activarBloqueoEspera();

			document.importarActividadesForm.action = '<html:rewrite action="/planificacionseguimiento/actividades/importarSalvar"/>' + xml;
			document.importarActividadesForm.submit();
		}
		
		function onSalvar()
		{
			if (document.importarActividadesForm.respuesta.value == "Error")
				return;
			else if (document.importarActividadesForm.respuesta.value == "action.guardarmetas.mensaje.guardarmetas.relacionados")
				return;
			else if (document.importarActividadesForm.respuesta.value == "action.guardarmediciones.mensaje.guardarmediciones.related")
				return;
			else if (document.importarActividadesForm.respuesta.value.indexOf('FileError') > -1)
			{
				var valores = document.importarActividadesForm.respuesta.value.split('|');
		...
		function mostrarBotones(paso) 
		{
			...
			switch (paso) 
			{
				...
				case 3:
					...
					botones = botones + crearBoton(nombreBotonSiguiente, accionBotonSiguiente) + separacion;
					botones = botones + crearBoton(nombreBotonCancelar, accionBotonCancelar) + separacion;
					if (document.importarActividadesForm.tipoFuente.value == "1" || document.importarActividadesForm.tipoFuente.value == "2")
		...
		{
			var titulo = '..:: <vgcutil:message key="jsp.asistente.importacion.actividad.titulo" /> ' + (_pasoActual + ' <vgcutil:message key="jsp.asistente.importacion.titulo3" />');
		...
		{
			if (_pasoActual == 2 && document.importarActividadesForm.tipoFuente.value == "1" && document.importarActividadesForm.separador.value == "")
			{
			...
			if (_pasoActual == 2 && 
					(document.importarActividadesForm.tipoFuente.value == "3" 
							|| document.importarActividadesForm.tipoFuente.value == "4"
							|| document.importarActividadesForm.tipoFuente.value == "5") && document.importarActividadesForm.bdNombre.value == "")
			{
		...
		function seleccionarArchivo(obj)
		{
			...
			if (document.importarActividadesForm.tipoFuente.value == "1" && extension.toUpperCase() != 'TXT')
			{
				alert('<vgcutil:message key="jsp.asistente.importacion.archivo.seleccion.tipo.txt.noexiste" /> ');
				limpiarArchivo();
				return
			}
			else if (document.importarActividadesForm.tipoFuente.value == "2" && document.importarActividadesForm.excelTipo[0].checked && extension.toUpperCase() != 'XLS')
			{
				alert('<vgcutil:message key="jsp.asistente.importacion.archivo.seleccion.tipo.excel.2007.noexiste" /> ');
				limpiarArchivo();
				return
			}
			else if (document.importarActividadesForm.tipoFuente.value == "2" && document.importarActividadesForm.excelTipo[1].checked && extension.toUpperCase() != 'XLSX')
			{
			...
			window.document.importarActividadesForm.fuenteSeleccion.value = obj.value;
			window.document.importarActividadesForm.fuenteSeleccionArchivo.value = archivo;
		}
		
		function limpiarArchivo()
		{
			window.document.importarActividadesForm.fuenteSeleccion.value = '';
			window.document.importarActividadesForm.fuenteSeleccionArchivo.value = '';
		...
		{
			if (document.importarActividadesForm.fuenteSeleccion.value == "" && (document.importarActividadesForm.tipoFuente.value == "1" || document.importarActividadesForm.tipoFuente.value == "2"))
			{
			...
			{
				xml = xml + '&password=' + document.importarActividadesForm.bdPassword.value;
				if (_verificarTabla)
		...
		{
			var respuesta = document.importarActividadesForm.respuesta.value;
			...
			if (document.importarActividadesForm.tipoFuente.value == "1" || document.importarActividadesForm.tipoFuente.value == "2")
			{
				...
				var hayFechaInicio = false;
				var hayFechaCulminacion = false;				
				...
				for (var i = 0; i < insumos.length; i++) 
				{
					...
					if (insumos[i].length > 0) 
					{
						...
						if (valores[0].toUpperCase() == "NUMERO ACTIVIDAD" && valores[1] == "true")
						{
							hayNumeroActividad = true;
							imagen = "Si.png";
						}
						if (valores[0].toUpperCase() == "NOMBRE ACTIVIDAD" && valores[1] == "true")
						{
							hayNombre = true;
							imagen = "Si.png";
						}
						...
						if (valores[0].toUpperCase() == "FECHA INICIO" && valores[1] == "true")
						{
							hayFechaInicio = true;
							imagen = "Si.png";
						}
						if (valores[0].toUpperCase() == "FECHA CULMINACION" && valores[1] == "true")
						{
						...
						if (valores[0].toUpperCase() == "UNIDAD MEDIDA" && valores[1] == "true")
						{
		...
		function eventoCambioFuente(limpiar)
		{
			...
			switch (document.importarActividadesForm.tipoFuente.value) 
			{
				case "1":
		...
		<%-- Funciones JavaScript externas de la pagina Jsp --%>
		<jsp:include flush="true" page="/componentes/ajax/ajaxJs.jsp"></jsp:include>

		<%-- Forma asociada al Action - Jsp --%>
		<html:form action="/planificacionseguimiento/actividades/importar"
			styleClass="formaHtmlCompleta" enctype="multipart/form-data"
			method="POST">
			...
			<input type="hidden" name="insumoSeleccionado"
				id="insumoSeleccionado">

			<%-- Campos hidden para el manejo de la insumos --%>
			<vgcinterfaz:contenedorForma width="570px" height="440px"
				bodyAlign="center" bodyValign="center" scrolling="none">
				...
				<table class="bordeFichaDatostabla bordeFichaDatos">
					<tr height=355px>
						...
						<td width="315px"><img
							src="<html:rewrite page='/paginas/strategos/iniciativas/importacion/imagenes/WZImportacion.gif'/>"
							border="0" width="150px" height="330px"></td>

						<td><vgcinterfaz:contenedorPaneles height="340px"
								width="390px" nombre="contenedorPanelesAsistente"
								mostrarSelectoresPaneles="false">

								<%-- Panel Presentacion --%>
								<vgcinterfaz:panelContenedor anchoPestana="50px"
									nombre="panelPresentacion" mostrarBorde="false">
									<table class="tablaSpacing0Padding0Width100Collapse">
												...
												<table class="tabla contenedorBotonesSeleccion">
													<tr>
														<td><b><vgcutil:message
																	key="jsp.asistente.importacion.presentacion.importante" /></b><br>
															<br> <vgcutil:message
																	key="jsp.asistente.importacion.actividad.presentacion.1" /><br>
															<br> <vgcutil:message
																	key="jsp.asistente.importacion.actividad.presentacion.2" /><br>
															<br> <vgcutil:message
																	key="jsp.asistente.importacion.presentacion.3" /></td>
													</tr>
												</table>
											</td>
										</tr>
										...
										<tr>
											<td class="contenedorTextoSeleccion"><html:checkbox
													property="showPresentacion"
													styleClass="botonSeleccionMultiple">
													<vgcutil:message
														key="jsp.asistente.importacion.presentacion.mostrar" />
												</html:checkbox></td>
										</tr>
									</table>
								...
								<vgcinterfaz:panelContenedor anchoPestana="50px"
									nombre="panelSeleccionTipo" mostrarBorde="false">
									<table class="tabla contenedorBotonesSeleccion">
										<tr>
											<td colspan="2"><vgcutil:message
													key="jsp.asistente.importacion.archivo.tipos" /></td>
											<td><html:select property="tipoFuente"
													styleClass="cuadroTexto" size="1"
													onchange="eventoCambioFuente(true)">
													<html:optionsCollection property="tiposFuentes" value="id"
														label="nombre" />
										...
										<tr id="trTipoPlan" style="display: none">
											<td colspan="3">
												<table class="tabla contenedorBotonesSeleccion">
													<tr valign="top">
														<td colspan="2"><vgcutil:message
																key="jsp.asistente.importacion.archivo.seleccion.separador" /></td>
														<td><html:text property="separador" size="5"
																maxlength="1" styleClass="cuadroTexto" /></td>
													</tr>
												</table>
											</td>
										</tr>
										<tr id="trTipoExcel" style="display: none">
											<td colspan="3">
												<table class="tabla contenedorBotonesSeleccion">
													<tr valign="top">
														<td colspan="2"><vgcutil:message
																key="jsp.asistente.importacion.archivo.seleccion.excel.tipo" /></td>
													</tr>
													<tr>
														<td><html:radio property="excelTipo" value="0">
																<vgcutil:message
																	key="jsp.asistente.importacion.archivo.seleccion.excel.tipo.2003" />
															</html:radio></td>
													</tr>
													<tr>
														<td><html:radio property="excelTipo" value="1">
																<vgcutil:message
																	key="jsp.asistente.importacion.archivo.seleccion.excel.tipo.2010" />
															</html:radio></td>
													</tr>
												</table>
											</td>
										...
										<tr id="trTipoOthers" style="display: none">
											<td colspan="3">
												<table class="tabla contenedorBotonesSeleccion">
													<tr valign="top">
														<td colspan="2"><vgcutil:message
																key="jsp.asistente.importacion.archivo.seleccion.bd.titulo" /></td>
													</tr>
													<tr>
														<td colspan="2"><vgcutil:message
																key="jsp.asistente.importacion.archivo.seleccion.bd.nombre" /></td>
														<td><html:text property="bdNombre" size="15"
																maxlength="50" styleClass="cuadroTexto" /></td>
													</tr>
													<tr>
														<td colspan="2"><vgcutil:message
																key="jsp.asistente.importacion.archivo.seleccion.bd.usuario" /></td>
														<td><html:text property="bdUsuario" size="15"
																maxlength="50" styleClass="cuadroTexto" /></td>
													</tr>
													<tr>
														<td colspan="2"><vgcutil:message
																key="jsp.asistente.importacion.archivo.seleccion.bd.password" /></td>
														<td><html:password property="bdPassword" size="15"
																maxlength="50" styleClass="cuadroTexto" /></td>
													</tr>
													<tr>
														<td colspan="2"><vgcutil:message
																key="jsp.asistente.importacion.archivo.seleccion.bd.servidor" /></td>
														<td><html:text property="bdServidor" size="15"
																maxlength="50" styleClass="cuadroTexto" /></td>
													</tr>
													<tr>
														<td colspan="2"><vgcutil:message
																key="jsp.asistente.importacion.archivo.seleccion.bd.puerto" /></td>
														<td><html:text property="bdPuerto" size="10"
																maxlength="6" styleClass="cuadroTexto" /></td>
													</tr>
												</table>
											</td>
										</tr>
								...
								<%-- Panel Verificar --%>
								<vgcinterfaz:panelContenedor anchoPestana="50px"
									nombre="panelVerficar" mostrarBorde="false">
									<table class="tabla contenedorBotonesSeleccion">
										<tr>
											<td><vgcutil:message
													key="jsp.asistente.importacion.medicion.seleccion.seleccionar.titulo" />
											</td>
										</tr>
										<tr>
											<td><input type="text" readonly style="width: 250px;"
												id="file_browse_text" /></td>
											<td style="width: 80px;">
												<div id="file_browse_wrapper">
													<input type="file" id="file_browse" name="file_browse"
														title="<vgcutil:message key="jsp.asistente.importacion.medicion.seleccion.seleccionar.archivo" />"
														onchange="seleccionarArchivo(this);" />
												</div>
											</td>
											<td style="width: 30px;"><img style="cursor: pointer"
										...
										<tr>
											<td><vgcutil:message
													key="jsp.asistente.importacion.medicion.seleccion.seleccionar.tabla" />
											</td>
										</tr>
										...
										<tr align="left">
											<td><input id="btnVerificar" name="btnVerificar"
												type="button" style="width: 150px" class="cuadroTexto"
												value="<vgcutil:message key="jsp.asistente.importacion.medicion.seleccion.seleccionar.verificar" />"
												onclick="verificarArchivo();" disabled="false"></td>
										</tr>
									</table>
								</vgcinterfaz:panelContenedor>
								...
								<%-- Panel Verificar --%>
								<vgcinterfaz:panelContenedor anchoPestana="50px"
									nombre="panelVerficarBD" mostrarBorde="false">
									<table class="tabla contenedorBotonesSeleccion">
										<tr valign="top" align="left">
											<td><input id="btnVerificar" name="btnVerificar"
												type="button" style="width: 150px" class="cuadroTexto"
												value="<vgcutil:message key="jsp.asistente.importacion.medicion.seleccion.seleccionar.verificar" />"
												onclick="verificarArchivo();"></td>
										</tr>
										<tr>
											<td><vgcutil:message
													key="jsp.asistente.importacion.medicion.seleccion.seleccionar.tabla.bd" />
											</td>
										</tr>
										<tr height="200px" valign="top">
											<td colspan="2">
										...
										<tr>
											<td colspan="3"><html:text property="bdTabla" size="30"
													styleClass="cuadroTexto" disabled="false" /> <img
												style="cursor: pointer" onclick="chequearArchivo();"
												src="<html:rewrite page='/componentes/fichaDatos/selector.gif'/>"
												border="0" width="10" height="10"
												title="<vgcutil:message key="boton.chequear.alt"/>">&nbsp;
												<img id="bdStatusCheck" style="cursor: pointer"
												src="<html:rewrite page='/paginas/strategos/indicadores/importacion/imagenes/No.gif'/>"
								...
								<%-- Panel Calcular --%>
								<vgcinterfaz:panelContenedor anchoPestana="50"
									nombre="panelCalcular" mostrarBorde="false">
									<table class="tabla contenedorBotonesSeleccion">
										<tr>
											<td><b><vgcutil:message
														key="jsp.asistente.importacion.calcular.mensaje1" /></b><br>
												<br> <vgcutil:message
													key="jsp.asistente.importacion.calcular.mensaje2" /><br>
												<vgcutil:message
													key="jsp.asistente.importacion.calcular.mensaje3" /><br>
											</td>
										</tr>
										<tr>
								...
								<%-- Panel Finalizar --%>
								<vgcinterfaz:panelContenedor anchoPestana="50" nombre="panelFin"
									mostrarBorde="false">
									<table class="tabla contenedorBotonesSeleccion">
										<tr>
											<td><b>Se van a importar actividades</b><br> <br>
												Presione finalizar para empezar la importación de las
												actividades<br> <br></td>
										</tr>
										<tr>
											<td><vgcutil:message
										...
										<tr>
											<td>
												<table class="tabla contenedorBotonesSeleccion">
													<tr>
														<td colspan="2"><vgcutil:message
																key="jsp.asistente.importacion.fin.reportar.titulo" /></td>
													</tr>
													<tr>
		...
		<script>
			//Inicio
			<logic:equal name="importarActividadesForm" property="status" value="0">
			if (document.importarActividadesForm.showPresentacion.checked)
				_pasoActual = 2;
			...
			<logic:equal name="importarActividadesForm" property="status" value="2">
			_pasoActual = 3;
			mostrarTitulo();
			mostrarBotones(_pasoActual);
			...
			// Importar
			<logic:equal name="importarActividadesForm" property="status" value="4">
			_pasoActual = 6;
			mostrarTitulo();
			mostrarBotones(_pasoActual);
			desactivarBloqueoEspera();
			if (document.importarActividadesForm.respuesta.value == "Successful")
			...
			<logic:equal name="importarActividadesForm" property="status" value="5">
			_setCloseParent = true;
			</logic:equal>

			// Leer configuracion
			<logic:equal name="importarActividadesForm" property="status" value="7">
			_pasoActual = 3;
			mostrarTitulo();
			mostrarBotones(_pasoActual);
			eventoCambioFuente(false);
			...
			// File Error
			<logic:equal name="importarActividadesForm" property="status" value="8">
			_pasoActual = 5;
			mostrarTitulo();
			mostrarBotones(_pasoActual);
			onSalvar();

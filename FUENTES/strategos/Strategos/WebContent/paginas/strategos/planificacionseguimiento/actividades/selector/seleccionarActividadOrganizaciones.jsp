...
<script language="JavaScript" type="text/javascript">
	...
	{
		window.location.href='<html:rewrite action="/actividades/selector/seleccionarActividadOrganizaciones"/>?seleccionarOrganizacionId=' + nodoId + '&llamadaDesde=Organizaciones' + marcadorAncla;
	}
	
	function abrirOrganizacion(nodoId, marcadorAncla) 
	{
		window.location.href='<html:rewrite action="/actividades/selector/seleccionarActividadOrganizaciones"/>?abrirOrganizacionId=' + nodoId + '&llamadaDesde=Organizaciones' + marcadorAncla;
	}
	
	function cerrarOrganizacion(nodoId, marcadorAncla) 
	{
		window.location.href='<html:rewrite action="/actividades/selector/seleccionarActividadOrganizaciones"/>?cerrarOrganizacionId=' + nodoId + '&llamadaDesde=Organizaciones' + marcadorAncla;
	}
...
<vgcinterfaz:contenedorForma mostrarBarraSuperior="false">
	...
	<treeview:treeview 
		useFrame="false" 
		arbolBean="seleccionarActividadArbolOrganizacionesBean" 
		scope="session" 
		isRoot="true" 
		fieldName="nombre" 

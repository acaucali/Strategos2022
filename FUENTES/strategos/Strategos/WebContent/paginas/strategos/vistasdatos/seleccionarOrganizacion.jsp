	...
	<tiles:put name="body" type="String">
		...
		<script language="JavaScript" type="text/javascript">			
			...
			function seleccionar() {
				...
				this.opener.document.<bean:write name="seleccionarOrganizacionForm" property="nombreForma" scope="session" />.<bean:write name="seleccionarOrganizacionForm" property="nombreCampoValor" scope="session" />.value=document.seleccionarOrganizacionForm.valoresSeleccionados.value;
				this.opener.document.<bean:write name="seleccionarOrganizacionForm" property="nombreForma" scope="session" />.<bean:write name="seleccionarOrganizacionForm" property="nombreCampoOculto" scope="session" />.value=document.seleccionarOrganizacionForm.seleccionados.value;				
				<logic:notEmpty name="seleccionarOrganizacionForm" property="funcionCierre" scope="session">					
					this.opener.<bean:write name="seleccionarOrganizacionForm" property="funcionCierre" scope="session" />;
				</logic:notEmpty>
				this.close();
			}
		...
		<html:form action="/vistasdatos/seleccionarOrganizacion" styleClass="formaHtml">

...
<tiles:insert definition="doc.selectorLayout" flush="true">
	...
	<tiles:put name="body" type="String">
		...
		<script type="text/javascript">			
			...
			var seleccionMultiple = '<bean:write name="seleccionarAtributoForm" property="seleccionMultiple" scope="session" />';
			
			function seleccionar() 
			{
				if ((document.seleccionarAtributoForm.seleccionados.value == null) || (document.seleccionarAtributoForm.seleccionados.value == "")) 
				{
					alert('<vgcutil:message key="jsp.seleccionar.noseleccion" />');
					return;
				}
				this.opener.document.<bean:write name="seleccionarAtributoForm" property="nombreForma" scope="session" />.<bean:write name="seleccionarAtributoForm" property="nombreCampoValor" scope="session" />.value=document.seleccionarAtributoForm.valoresSeleccionados.value;
				this.opener.document.<bean:write name="seleccionarAtributoForm" property="nombreForma" scope="session" />.<bean:write name="seleccionarAtributoForm" property="nombreCampoOculto" scope="session" />.value=document.seleccionarAtributoForm.seleccionados.value;				
				<logic:notEmpty name="seleccionarAtributoForm" property="funcionCierre" scope="session">					
					this.opener.<bean:write name="seleccionarAtributoForm" property="funcionCierre" scope="session" />;
				</logic:notEmpty>
				this.close();
			}
			...
			function eventoMouseEncimaFilaSeleccion(idsSeleccionados, fila) 
			{
		   	...
		   	{
				seleccionarAtributoForm.filtroNombre.value = "";
				seleccionarAtributoForm.submit();
			}
		...
		<html:form action="/vistasdatos/seleccionarAtributo" styleClass="formaHtml">
			...
			<vgcinterfaz:contenedorForma esSelector="true" comandoAceptarSelector="seleccionar()" comandoCancelarSelector="window.close()">
				...
				<vgcinterfaz:contenedorFormaBotonActualizar>
					javascript:document.seleccionarAtributoForm.submit();
				</vgcinterfaz:contenedorFormaBotonActualizar>
				...
				<table class="listView" cellpadding="5" id="tablaAtributo" cellspacing="1">
					...
					<logic:iterate name="seleccionarAtributoForm" property="listaAtributos" scope="session" id="atributo">
						<tr onclick="eventoClickFilaSeleccion(document.seleccionarAtributoForm.seleccionados, document.seleccionarAtributoForm.valoresSeleccionados, 'tablaAtributo', this)"
							id="<bean:write name="atributo" property="valor" />" class="mouseFueraCuerpoListView" onMouseOver="eventoMouseEncimaFilaSeleccion(document.seleccionarAtributoForm.seleccionados, this)"
							onMouseOut="eventoMouseFueraFilaSeleccion(document.seleccionarAtributoForm.seleccionados, this)" height="20px">
			...
			<script type="text/javascript">
				...
				inicializarVisorListaSeleccion(document.seleccionarAtributoForm.seleccionados, 'tablaAtributo');

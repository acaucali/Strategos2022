			...
			<vgcinterfaz:contenedorMenuHorizontal>
				...
				<vgcinterfaz:contenedorMenuHorizontalItem>
					<vgcinterfaz:menuBotones id="menuEdicion" key="menu.edicion">
						...
						<%-- Validaci�n: solo se puede crear Perspectiva si hay un elemento en la Plantilla de Planes --%>
						...
						<%-- Validaci�n: si la Perspectiva seleccionada NO es Ra�z, entonces se modifica la Perspectiva  --%>
						...
						<%-- Validaci�n: si la Perspectiva seleccionada SI es Ra�z, entonces se modifica el Plan --%>
						...
						<%-- Validaci�n: si la Perspectiva seleccionada NO es Ra�z, entonces se permite Eliminar y Propiedades de la Perspectiva  --%>
						<logic:notEmpty name="perspectiva" property="padreId" scope="session">
				...
				<vgcinterfaz:contenedorMenuHorizontalItem>
					<vgcinterfaz:menuBotones id="menuVer" key="menu.ver">
						...
						<vgcinterfaz:botonMenu key="menu.ver.dise�o.causaefecto" onclick="gestionarModeloCausaEfecto()" permisoId="PLAN_MODELO_DISENO" agregarSeparador="true" /> --%>
						<vgcinterfaz:botonMenu key="menu.ver.visualizarplan" onclick="visualizarPlan()" permisoId="PLAN_EJECUTIVO" agregarSeparador="true" />
						<%-- 
						<vgcinterfaz:botonMenu key="menu.ver.indicadoresasociadosproblemas" onclick="alert('Funci�n no disponible')" permisoId="PROBLEMA" />
						<vgcinterfaz:botonMenu key="menu.ver.planesrelacionados" onclick="alert('Funci�n no disponible')" permisoId="PLAN" agregarSeparador="true" />
						 --%>

						<%-- Validaci�n: Se muestran los Indicadores de Logro del Plan --%>
						...
						<%-- Validaci�n: Se muestran los Indicadores de Logro de los Hijos del Plan --%>
						<logic:equal name="gestionarPerspectivasForm" property="verIndicadoresLogroPlan" value="true">
							<logic:notEmpty name="perspectiva" property="padreId" scope="session">
...
<vgcutil:valorPropertyIgual nombre="com.visiongc.app.strategos.web.configuracion.StrategosWebConfiguration" property="jsp.planes.perspectivas.gestionarperspectivas.barrainferior.mostrar" valor="true">
<script>
	<%-- Arma la descripci�n al final del �rbol --%>

...
<table width="100%" cellpadding="0" cellspacing="0">
	<tr>
		...
		<table border="0">
			<tr>
				<td><img src="<html:rewrite page='/componentes/barraAplicacion/logoAplicacion.gif'/>" border="0"></td>
			</tr>
		</table>
		</td>
		<td align="center" class="mouseFueraBarraAplicacionPrincipal">
			<font size="5"><vgcutil:message key="aplicacion.nombre" /></font>
		</td>

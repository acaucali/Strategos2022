...
public class StrategosReportesGraficoServiceImpl
  extends StrategosServiceImpl
  implements StrategosReportesGraficoService
{
  private StrategosReportesGraficoPersistenceSession persistenceSession = null;
  
  public StrategosReportesGraficoServiceImpl(StrategosReportesGraficoPersistenceSession persistenceSession, boolean persistenceOwned, StrategosServiceFactory serviceFactory, VgcMessageResources messageResources)
  {
  ...
  public int deleteReporte(ReporteGrafico reporte, Usuario usuario)
  {
  ...
  public int save(ReporteGrafico reporte, Usuario usuario)
  {
    boolean transActiva = false;
    int resultado = 10000;
	...
	public ReporteGrafico obtenerReporte(Long reporteId) {
		return persistenceSession.obtenerReporte(reporteId);
	}
}

...
public class OrganizacionStrategos extends OrganizacionBasica
		implements Serializable, NodoArbol, OrganizacionPermisologia, Visibilidad, SoloLectura {
	...
	public OrganizacionStrategos(Long organizacionId, Long padreId, String nombre, String direccion, Date creado,
			Date modificado, Long creadoId, Long modificadoId, String rif, String telefono, String fax, Byte mesCierre,
			Integer porcentajeZonaAmarillaMinMaxIndicadores, Integer porcentajeZonaVerdeMetaIndicadores,
			Integer porcentajeZonaAmarillaMetaIndicadores, Integer porcentajeZonaVerdeIniciativas,
			Integer porcentajeZonaAmarillaIniciativas) {

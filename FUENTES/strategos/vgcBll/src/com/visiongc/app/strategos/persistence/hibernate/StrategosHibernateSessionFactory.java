...
import com.visiongc.app.strategos.cargos.persistence.hibernate.StrategosCargosHibernateSession;
...
public class StrategosHibernateSessionFactory
		implements com.visiongc.app.strategos.persistence.StrategosPersistenceSessionFactory {
	...
	public StrategosUnidadesPersistenceSession openUnidadesPersistenceSession() {
		...
		try {
			persistenceSession = new StrategosUnidadesHibernateSession(
					VgcHibernateSessionFactory.getHibernateSessionFactory().openSession());
		} catch (Exception e) {
			try {
				throw new Exception("No se pudo crear una sesión de persistencia de hibernate de Unidades de Strategos",
						e);
	...
	public StrategosCategoriasPersistenceSession openCategoriasPersistenceSession() {
		...
		try {
			persistenceSession = new StrategosCategoriasHibernateSession(
					VgcHibernateSessionFactory.getHibernateSessionFactory().openSession());
		} catch (Exception e) {
			try {
				throw new Exception(
						"No se pudo crear una sesión de persistencia de hibernate de Categorias de Strategos", e);
			} catch (Exception localException1) {
			}
		}
		return persistenceSession;
	...
	public StrategosCargosPersistenceSession openCargosPersistenceSession() {
		StrategosCargosPersistenceSession persistenceSession = null;
		try {
			persistenceSession = new StrategosCargosHibernateSession(
					VgcHibernateSessionFactory.getHibernateSessionFactory().openSession());
		} catch (Exception e) {
			try {
				throw new Exception("No se pudo crear una sesión de persistencia de hibernate de Cargos de Strategos",
						e);
			} catch (Exception localException1) {
			}
		}
	...
	public StrategosCargosPersistenceSession openCargosPersistenceSession(StrategosPersistenceSession strategosPersistenceSession) {
		...
		StrategosHibernateSession strategosHibernateSession = (StrategosHibernateSession) strategosPersistenceSession;
		try {
			persistenceSession = new StrategosCargosHibernateSession(strategosHibernateSession);
		} catch (Exception e) {
			try {
				throw new Exception("No se pudo crear una sesión de persistencia de hibernate de Cargos de Strategos",
						e);
	...
	public StrategosResponsablesPersistenceSession openResponsablesPersistenceSession() {
		...
		try {
			persistenceSession = new StrategosResponsablesHibernateSession(
					VgcHibernateSessionFactory.getHibernateSessionFactory().openSession());
		} catch (Exception e) {
			try {
				throw new Exception(
						"No se pudo crear una sesión de persistencia de hibernate de Responsables de Strategos", e);
			} catch (Exception localException1) {
			}
		}
		return persistenceSession;
	...
	public StrategosCuentasPersistenceSession openCuentasPersistenceSession() {
		...
		try {
			persistenceSession = new StrategosCuentasHibernateSession(
					VgcHibernateSessionFactory.getHibernateSessionFactory().openSession());
		} catch (Exception e) {
			try {
				throw new Exception("No se pudo crear una sesión de persistencia de hibernate de Cuentas de Strategos",
						e);
			} catch (Exception localException1) {
			}
		}
	...
	public StrategosCausasPersistenceSession openCausasPersistenceSession() {
		...
		try {
			persistenceSession = new StrategosCausasHibernateSession(
					VgcHibernateSessionFactory.getHibernateSessionFactory().openSession());
		} catch (Exception e) {
			try {
				throw new Exception("No se pudo crear una sesión de persistencia de hibernate de Causas de Strategos",
						e);
			} catch (Exception localException1) {
			}
		}
	...
	public StrategosEstadosPersistenceSession openEstadosPersistenceSession() {
		...
		try {
			persistenceSession = new StrategosEstadosHibernateSession(
					VgcHibernateSessionFactory.getHibernateSessionFactory().openSession());
		} catch (Exception e) {
			try {
				throw new Exception("No se pudo crear una sesión de persistencia de hibernate de Estados de Strategos",
						e);
			} catch (Exception localException1) {
			}
		}
	...
	public StrategosSeriesTiempoPersistenceSession openSeriesTiempoPersistenceSession() {
		...
		try {
			persistenceSession = new StrategosSeriesTiempoHibernateSession(
					VgcHibernateSessionFactory.getHibernateSessionFactory().openSession());
		} catch (Exception e) {
			try {
				throw new Exception(
						"No se pudo crear una sesión de persistencia de hibernate de Series de Tiempo de Strategos", e);
			} catch (Exception localException1) {
			}
		}
		return persistenceSession;
	...
	public StrategosOrganizacionesPersistenceSession openOrganizacionesPersistenceSession() {
		...
		try {
			persistenceSession = new StrategosOrganizacionesHibernateSession(
					VgcHibernateSessionFactory.getHibernateSessionFactory().openSession());
		} catch (Exception e) {
			try {
				throw new Exception(
						"No se pudo crear una sesión de persistencia de hibernate de Organizaciones de Strategos", e);
			} catch (Exception localException1) {
			}
		}
		return persistenceSession;
	...
	public StrategosClasesIndicadoresPersistenceSession openClasesIndicadoresPersistenceSession() {
		...
		try {
			persistenceSession = new StrategosClasesIndicadoresHibernateSession(
					VgcHibernateSessionFactory.getHibernateSessionFactory().openSession());
		} catch (Exception e) {
			try {
				throw new Exception(
						"No se pudo crear una sesión de persistencia de hibernate de Clases de Indicadores de Strategos",
						e);
			} catch (Exception localException1) {
			}
		}
	...
	public StrategosIndicadoresPersistenceSession openIndicadoresPersistenceSession() {
		...
		try {
			persistenceSession = new StrategosIndicadoresHibernateSession(
					VgcHibernateSessionFactory.getHibernateSessionFactory().openSession());
		} catch (Exception e) {
			try {
				throw new Exception(
						"No se pudo crear una sesión de persistencia de hibernate de Indicadores de Strategos", e);
			} catch (Exception localException1) {
			}
		}
		return persistenceSession;
	...
	public StrategosIndicadorAsignarInventarioPersistenceSession openIndicadorAsignarInventarioPersistenceSession() {
		...
		try {
			persistenceSession = new StrategosIndicadorAsignarInventarioHibernateSession(
					VgcHibernateSessionFactory.getHibernateSessionFactory().openSession());
		} catch (Exception e) {
			try {
				throw new Exception(
						"No se pudo crear una sesi�n de persistencia de hibernate de Indicadores de Strategos", e);
			} catch (Exception localException1) {
			}
		}
		return persistenceSession;
	...
	public StrategosMedicionesPersistenceSession openMedicionesPersistenceSession() {
		...
		try {
			persistenceSession = new StrategosMedicionesHibernateSession(
					VgcHibernateSessionFactory.getHibernateSessionFactory().openSession());
		} catch (Exception e) {
			try {
				throw new Exception(
						"No se pudo crear una sesión de persistencia de hibernate de Mediciones de Strategos", e);
			} catch (Exception localException1) {
			}
		}
		return persistenceSession;
	...
	public StrategosMedicionesValoracionPersistenceSession openMedicionesValoracionPersistenceSession() {
		...
		try {
			persistenceSession = new StrategosMedicionesValoracionHibernateSession(
					VgcHibernateSessionFactory.getHibernateSessionFactory().openSession());
		} catch (Exception e) {
			try {
				throw new Exception(
						"No se pudo crear una sesi�n de persistencia de hibernate de Mediciones de Strategos", e);
			} catch (Exception localException1) {
			}
		}
		return persistenceSession;
	...
	public StrategosPlantillasPlanesPersistenceSession openPlantillasPlanesPersistenceSession() {
		...
		try {
			persistenceSession = new com.visiongc.app.strategos.planes.persistence.hibernate.StrategosPlantillasPlanesHibernateSession(
					VgcHibernateSessionFactory.getHibernateSessionFactory().openSession());
		} catch (Exception e) {
			try {
				throw new Exception(
						"No se pudo crear una sesión de persistencia de hibernate de Plantillas de Planes de Strategos",
						e);
			} catch (Exception localException1) {
			}
		}
	...
	public StrategosIniciativasPersistenceSession openIniciativasPersistenceSession() {
		...
		try {
			persistenceSession = new StrategosIniciativasHibernateSession(
					VgcHibernateSessionFactory.getHibernateSessionFactory().openSession());
		} catch (Exception e) {
			try {
				throw new Exception(
						"No se pudo crear una sesión de persistencia de hibernate de Iniciativas de Strategos", e);
			} catch (Exception localException1) {
			}
		}
		return persistenceSession;
	...
	public StrategosPryProyectosPersistenceSession openPryProyectosPersistenceSession() {
		...
		try {
			persistenceSession = new StrategosPryProyectosHibernateSession(
					VgcHibernateSessionFactory.getHibernateSessionFactory().openSession());
		} catch (Exception e) {
			try {
				throw new Exception(
						"No se pudo crear una sesión de persistencia de hibernate de PryProyectos de Strategos", e);
			} catch (Exception localException1) {
			}
		}
		return persistenceSession;
	...
	public StrategosPryActividadesPersistenceSession openPryActividadesPersistenceSession() {
		...
		try {
			persistenceSession = new StrategosPryActividadesHibernateSession(
					VgcHibernateSessionFactory.getHibernateSessionFactory().openSession());
		} catch (Exception e) {
			try {
				throw new Exception(
						"No se pudo crear una sesión de persistencia de hibernate de PryActividades de Strategos", e);
			} catch (Exception localException1) {
			}
		}
		return persistenceSession;
	...
	public StrategosPryVistasPersistenceSession openPryVistasPersistenceSession() {
		...
		try {
			persistenceSession = new StrategosPryVistasHibernateSession(
					VgcHibernateSessionFactory.getHibernateSessionFactory().openSession());
		} catch (Exception e) {
			try {
				throw new Exception(
						"No se pudo crear una sesión de persistencia de hibernate de PryVistas de Strategos", e);
			} catch (Exception localException1) {
			}
		}
		return persistenceSession;
	...
	public StrategosProblemasPersistenceSession openProblemasPersistenceSession() {
		...
		try {
			persistenceSession = new StrategosProblemasHibernateSession(
					VgcHibernateSessionFactory.getHibernateSessionFactory().openSession());
		} catch (Exception e) {
			try {
				throw new Exception(
						"No se pudo crear una sesión de persistencia de hibernate de Problemas de Strategos", e);
			} catch (Exception localException1) {
			}
		}
		return persistenceSession;
	...
	public StrategosClasesProblemasPersistenceSession openClasesProblemasPersistenceSession() {
		...
		try {
			persistenceSession = new StrategosClasesProblemasHibernateSession(
					VgcHibernateSessionFactory.getHibernateSessionFactory().openSession());
		} catch (Exception e) {
			try {
				throw new Exception(
						"No se pudo crear una sesión de persistencia de hibernate de Clases de Problemas de Strategos",
						e);
			} catch (Exception localException1) {
			}
		}
	...
	public StrategosSeguimientosPersistenceSession openSeguimientosPersistenceSession() {
		...
		try {
			persistenceSession = new StrategosSeguimientosHibernateSession(
					VgcHibernateSessionFactory.getHibernateSessionFactory().openSession());
		} catch (Exception e) {
			try {
				throw new Exception(
	...
	public StrategosAccionesPersistenceSession openAccionesPersistenceSession() {
		...
		try {
			persistenceSession = new StrategosAccionesHibernateSession(
					VgcHibernateSessionFactory.getHibernateSessionFactory().openSession());
		} catch (Exception e) {
			try {
				throw new Exception(
	...
	public StrategosVistasPersistenceSession openVistasPersistenceSession() {
		...
		try {
			persistenceSession = new StrategosVistasHibernateSession(
					VgcHibernateSessionFactory.getHibernateSessionFactory().openSession());
		} catch (Exception e) {
			try {
				throw new Exception("No se pudo crear una sesión de persistencia de hibernate de Vistas de Strategos",
						e);
			} catch (Exception localException1) {
			}
		}
	...
	public StrategosExplicacionesPersistenceSession openExplicacionesPersistenceSession() {
		...
		try {
			persistenceSession = new StrategosExplicacionesHibernateSession(
					VgcHibernateSessionFactory.getHibernateSessionFactory().openSession());
		} catch (Exception e) {
			try {
				throw new Exception(
						"No se pudo crear una sesión de persistencia de hibernate de Explicaciones de Strategos", e);
			} catch (Exception localException1) {
			}
		}
		return persistenceSession;
	...
	public StrategosForosPersistenceSession openForosPersistenceSession() {
		...
		try {
			persistenceSession = new StrategosForosHibernateSession(
					VgcHibernateSessionFactory.getHibernateSessionFactory().openSession());
		} catch (Exception e) {
			try {
				throw new Exception("No se pudo crear una sesión de persistencia de hibernate de Foros de Strategos",
						e);
			} catch (Exception localException1) {
			}
		}
	...
	public StrategosPortafoliosPersistenceSession openPortafoliosPersistenceSession() {
		...
		try {
			persistenceSession = new StrategosPortafoliosHibernateSession(
					VgcHibernateSessionFactory.getHibernateSessionFactory().openSession());
		} catch (Exception e) {
			try {
				throw new Exception(
						"No se pudo crear una sesión de persistencia de hibernate de Portafolios de Strategos", e);
			} catch (Exception localException1) {
			}
		}
		return persistenceSession;
	...
	public StrategosPaginasPersistenceSession openPaginasPersistenceSession() {
		...
		try {
			persistenceSession = new StrategosPaginasHibernateSession(
					VgcHibernateSessionFactory.getHibernateSessionFactory().openSession());
		} catch (Exception e) {
			try {
				throw new Exception(
						"No se pudo crear una sesión de persistencia de hibernate de Importaciones de Strategos", e);
			} catch (Exception localException1) {
			}
		}
		return persistenceSession;
	...
	public StrategosCeldasPersistenceSession openCeldasPersistenceSession() {
		...
		try {
			persistenceSession = new StrategosCeldasHibernateSession(
					VgcHibernateSessionFactory.getHibernateSessionFactory().openSession());
		} catch (Exception e) {
			try {
				throw new Exception(
	...
	public StrategosPrdProductosPersistenceSession openPrdProductosPersistenceSession() {
		...
		try {
			persistenceSession = new StrategosPrdProductosHibernateSession(
					VgcHibernateSessionFactory.getHibernateSessionFactory().openSession());
		} catch (Exception e) {
			try {
				throw new Exception(
						"No se pudo crear una sesión de persistencia de hibernate de Productos de Strategos", e);
			} catch (Exception localException1) {
			}
		}
		return persistenceSession;
	...
	public StrategosPlanesPersistenceSession openPlanesPersistenceSession() {
		...
		try {
			persistenceSession = new com.visiongc.app.strategos.planes.persistence.hibernate.StrategosPlanesHibernateSession(
					VgcHibernateSessionFactory.getHibernateSessionFactory().openSession());
		} catch (Exception e) {
			try {
				throw new Exception("No se pudo crear una sesión de persistencia de hibernate de Planes", e);
			} catch (Exception localException1) {
			}
		}
		return persistenceSession;
	...
	public StrategosMetasPersistenceSession openMetasPersistenceSession() {
		...
		try {
			persistenceSession = new StrategosMetasHibernateSession(
					VgcHibernateSessionFactory.getHibernateSessionFactory().openSession());
		} catch (Exception e) {
			try {
				throw new Exception("No se pudo crear una sesión de persistencia de hibernate de Metas", e);
			} catch (Exception localException1) {
			}
		}
		return persistenceSession;
	...
	public StrategosPerspectivasPersistenceSession openPerspectivasPersistenceSession() {
		...
		try {
			persistenceSession = new StrategosPerspectivasHibernateSession(
					VgcHibernateSessionFactory.getHibernateSessionFactory().openSession());
		} catch (Exception e) {
			try {
				throw new Exception("No se pudo crear una sesión de persistencia de hibernate de Perspectivas", e);
			} catch (Exception localException1) {
			}
		}
		return persistenceSession;
	...
	public StrategosModelosPersistenceSession openModelosPersistenceSession() {
		...
		try {
			persistenceSession = new StrategosModelosHibernateSession(
					VgcHibernateSessionFactory.getHibernateSessionFactory().openSession());
		} catch (Exception e) {
			try {
				throw new Exception("No se pudo crear una sesión de persistencia de hibernate de Modelos", e);
			} catch (Exception localException1) {
			}
		}
		return persistenceSession;
	...
	public StrategosVistasDatosPersistenceSession openVistasDatosPersistenceSession() {
		...
		try {
			persistenceSession = new StrategosVistasDatosHibernateSession(
					VgcHibernateSessionFactory.getHibernateSessionFactory().openSession());
		} catch (Exception e) {
			try {
				throw new Exception(
						"No se pudo crear una sesión de persistencia de hibernate de VistasDatos de Strategos", e);
			} catch (Exception localException1) {
			}
		}
		return persistenceSession;
	...
	public StrategosReportesPersistenceSession openReportesPersistenceSession() {
		...
		try {
			persistenceSession = new StrategosReportesHibernateSession(
					VgcHibernateSessionFactory.getHibernateSessionFactory().openSession());
		} catch (Exception e) {
			try {
				throw new Exception("No se pudo crear una sesión de persistencia de hibernate de Reportes de Strategos",
						e);
			} catch (Exception localException1) {
			}
		}
	...
	public StrategosReportesPersistenceSession openReportesPersistenceSession(
		...
		try {
			...
			try {
				throw new Exception("No se pudo crear una sesión de persistencia de hibernate de Reporte de Strategos",
						e);
			} catch (Exception localException1) {
			}
		}
	...
	public StrategosReportesGraficoPersistenceSession openReportesGraficoPersistenceSession() {
		...
		try {
			persistenceSession = new StrategosReportesGraficoHibernateSession(
					VgcHibernateSessionFactory.getHibernateSessionFactory().openSession());
		} catch (Exception e) {
			try {
				throw new Exception("No se pudo crear una sesión de persistencia de hibernate de Reportes de Strategos",
	...
	public StrategosGraficosPersistenceSession openGraficosPersistenceSession() {
		...
		try {
			persistenceSession = new StrategosGraficosHibernateSession(
					VgcHibernateSessionFactory.getHibernateSessionFactory().openSession());
		} catch (Exception e) {
			try {
				throw new Exception("No se pudo crear una sesión de persistencia de hibernate de Graficos de Strategos",
						e);
			} catch (Exception localException1) {
			}
		}
	...
	public StrategosGraficosPersistenceSession openGraficosPersistenceSession(
		...
		try {
			...
			try {
				throw new Exception("No se pudo crear una sesión de persistencia de hibernate de Grafico de Strategos",
						e);
			} catch (Exception localException1) {
			}
		}
	...
	public StrategosIniciativaEstatusPersistenceSession openIniciativaEstatusPersistenceSession() {
		...
		try {
			persistenceSession = new StrategosIniciativaEstatusHibernateSession(
					VgcHibernateSessionFactory.getHibernateSessionFactory().openSession());
		} catch (Exception e) {
			try {
				throw new Exception(
						"No se pudo crear una sesión de persistencia de hibernate de Estatus de la Iniciativa de Strategos",
						e);
			} catch (Exception localException1) {
			}
		}
	...
	public StrategosCodigoEnlacePersistenceSession openCodigoEnlacePersistenceSession() {
		...
		try {
			persistenceSession = new StrategosCodigoEnlaceHibernateSession(
					VgcHibernateSessionFactory.getHibernateSessionFactory().openSession());
		} catch (Exception e) {
			try {
				throw new Exception(
						"No se pudo crear una sesión de persistencia de hibernate de Codigo de Enlace de Strategos", e);
			} catch (Exception localException1) {
			}
		}
	...
	public StrategosTipoProyectoPersistenceSession openTipoProyectoPersistenceSession() {
		...
		try {
			persistenceSession = new StrategosTipoProyectoHibernateSession(
					VgcHibernateSessionFactory.getHibernateSessionFactory().openSession());
		} catch (Exception e) {
			try {
				throw new Exception(
	...
	public StrategosTiposConvenioPersistenceSession openTiposConvenioPersistenceSession() {
		...
		try {
			persistenceSession = new StrategosTiposConvenioHibernateSession(
					VgcHibernateSessionFactory.getHibernateSessionFactory().openSession());
		} catch (Exception e) {
			try {
				throw new Exception(
	...
	public StrategosCooperantesPersistenceSession openCooperantesPersistenceSession() {
		...
		try {
			persistenceSession = new StrategosCooperantesHibernateSession(
					VgcHibernateSessionFactory.getHibernateSessionFactory().openSession());
		} catch (Exception e) {
			try {
				throw new Exception(
	...
	public StrategosInstrumentosPersistenceSession openInstrumentosPersistenceSession() {
		...
		try {
			persistenceSession = new StrategosInstrumentosHibernateSession(
					VgcHibernateSessionFactory.getHibernateSessionFactory().openSession());
		} catch (Exception e) {
			try {
				throw new Exception(

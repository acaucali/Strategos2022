...
@Component({
  selector: 'consultaidea',
  templateUrl: './consultaidea.component.html',
  styleUrls: ['./consultaidea.component.css']
})
export class ConsultaideaComponent implements OnInit {
  ...
  constructor(public modalservice: ModalConsultaService, private router: Router, private estatusService: EstatusIdeaService, private propuestasService: TiposPropuestaService,
    private objetivosService: TiposObejtivosService, private activatedRoute: ActivatedRoute, private ideaService: IdeasProyectosService, 

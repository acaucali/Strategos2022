...
CREATE SEQUENCE VISION_UNIQUE_ID
	START WITH 50			/* inicia en 2. La organizacion, grupo y usuario precargados tienen un ID=10 */
	INCREMENT BY 1
	NOMAXVALUE
	NOCYCLE
	NOCACHE
...
INSERT INTO AFW_USUARIO (USUARIO_ID, FULL_NAME, U_ID, PWD, IS_ADMIN, IS_CONNECTED, INACTIVO, ESTATUS, BLOQUEADO, IS_SYSTEM) VALUES (1, 'Administrador', 'admin', 'xx', 1, 0, 0, 0, 0, 1);
UPDATE AFW_USUARIO SET PWD = chr('38') || 'H07056D763639BF0585A18A0E5BAB9343CBA302B251758A1953191E03342B';
INSERT INTO ORGANIZACION (ORGANIZACION_ID, NOMBRE, MES_CIERRE, READ_ONLY, VISIBLE) VALUES (2, 'Organizaciones', 12, 0, 1);
...
INSERT INTO AFW_SISTEMA (id, version, RDBMS_ID, PRODUCTO, CONEXION) VALUES (3, '1.0.0.1', 'ORACLE', 'PROTOTIPO', '2063<46,2451?589><=-(''#');
...
BEGIN
	SELECT COUNT(*) INTO vCount FROM afw_modulo WHERE id = '0DC25625-AF06-4F7C-B981-258AEAF18C01' AND activo = 1;
	IF vCount > 0 THEN 
	BEGIN
...
INSERT INTO Causa (Causa_Id, Padre_Id, Nombre, Descripcion, Nivel) VALUES (4, NULL, 'Causa', 'Causa Padre', 1);

/************************************************/
/************************************************/

INSERT INTO pry_calendario(calendario_id, nombre, dom, lun, mar, mie, jue, vie, sab, proyecto_id) VALUES (5, 'Estandard', 1, 0, 0, 0, 0, 0, 1, NULL);

/************************************************/ 
/************************************************/ 

INSERT INTO afw_message_resource(clave, valor) VALUES ('formato.numero', '###,##0.00');

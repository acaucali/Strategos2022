...
/************************************************/
/*            	Administracion            	  	*/
INSERT INTO AFW_PERMISO (PERMISO_ID, PADRE_ID, PERMISO, NIVEL, GRUPO, GLOBAL, DESCRIPCION) VALUES ('CONFIGURACION',  NULL,  'Administración',  0,  0,  1,   'Administración');
--Inicio de Sesión
...
--Categoria
INSERT INTO AFW_PERMISO (permiso_id, permiso, padre_id, nivel, grupo, global, descripcion) VALUES ('CATEGORIA', 'Gestionar Categorías de Medición', NULL, 0, 4, 1, 'Gestionar Categorías de Medición');
...
INSERT INTO AFW_PERMISO (permiso_id, permiso, padre_id, nivel, grupo, global, descripcion) VALUES ('INICIATIVA_GESTION', 'Gestión', 'INICIATIVA', 2, 9, 0, 'Gestión');
--Producto
...
--Indicador
INSERT INTO AFW_PERMISO (permiso_id, permiso, padre_id, nivel, grupo, global, descripcion) VALUES ('INDICADOR_RAIZ', 'Módulo de Indicadores', 'ORGANIZACION', 1, 9, 0, 'Módulo de Indicadores');
-- Clase
...
INSERT INTO afw_permiso( permiso_id,  padre_id,  permiso,  nivel,  grupo,  global,  descripcion) VALUES ('INDICADOR_MEDICION_PROTECCION',  'INDICADOR_MEDICION',  'Protección',  4,   4,   0,  'Protección');
...
INSERT INTO afw_permiso( permiso_id,  padre_id,  permiso,  nivel,  grupo,  global,  descripcion) VALUES ('INDICADOR_EVALUAR',  'INDICADOR',  'Evaluación de Indicadores',  3,   8,   0,  'Evaluación de Indicadores');
...
--Problemas
INSERT INTO AFW_PERMISO (permiso_id, permiso, padre_id, nivel, grupo, global, descripcion) VALUES ('PROBLEMA_RAIZ', 'Módulo de Problemas', 'ORGANIZACION', 1, 12, 0, 'Módulo de Problemas');
